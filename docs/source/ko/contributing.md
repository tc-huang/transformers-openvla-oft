...
☐ 모든 공개 메소드는 유용한 기술문서를 가져야 합니다 (예를 들어 [`modeling_bert.py`](https://github.com/huggingface/transformers/blob/main/src/transformers_openvla_oft/models/bert/modeling_bert.py) 참조).<br>
...
더 많은 환경 변수와 추가 정보는 [testing_utils.py](src/transformers_openvla_oft/testing_utils.py)에서 찾을 수 있습니다.
