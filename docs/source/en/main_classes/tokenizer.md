...
loaded very simply into 🤗 transformers_openvla_oft. Take a look at the [Using tokenizers from 🤗 tokenizers](../fast_tokenizers) page to understand how this is done.
