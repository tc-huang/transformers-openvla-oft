...
- The original checkpoints can be converted using the conversion script [`src/transformers_openvla_oft/models/recurrent_gemma/convert_recurrent_gemma_weights_to_hf.py`](https://github.com/huggingface/transformers/blob/main/src/transformers_openvla_oft/models/recurrent_gemma/convert_recurrent_gemma_to_hf.py). 
