...
```py
from transformers_openvla_oft import SwinConfig, UperNetConfig, UperNetForSemanticSegmentation
...
```py
from transformers_openvla_oft import ConvNextConfig, UperNetConfig, UperNetForSemanticSegmentation
