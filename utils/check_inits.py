...
make the line `import transformers_openvla_oft` very slow when the user has all optional dependencies installed. The inits with
...
def check_submodules():
    ...
    import_structure_keys = set(transformers_openvla_oft._import_structure.keys())
