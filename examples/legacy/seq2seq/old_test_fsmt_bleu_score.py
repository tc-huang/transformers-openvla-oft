...
from transformers_openvla_oft import FSMTForConditionalGeneration, FSMTTokenizer
from transformers_openvla_oft.testing_utils import get_tests_dir, require_torch, slow, torch_device
