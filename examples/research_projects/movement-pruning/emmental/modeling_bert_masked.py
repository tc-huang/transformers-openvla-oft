...
Built on top of `transformers_openvla_oft.models.bert.modeling_bert`"""
...
from transformers_openvla_oft.modeling_utils import PreTrainedModel, prune_linear_layer
from transformers_openvla_oft.models.bert.modeling_bert import ACT2FN, load_tf_weights_in_bert
...
MASKED_BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~emmental.MaskedBertConfig`): Model configuration class with all the parameters of the model.
            ...
            Check out the :meth:`~transformers_openvla_oft.PreTrainedModel.from_pretrained` method to load the model weights.
"""
...
MASKED_BERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformers_openvla_oft.BertTokenizer`.
            See :func:`transformers_openvla_oft.PreTrainedTokenizer.encode` and
            :func:`transformers_openvla_oft.PreTrainedTokenizer.__call__` for details.
...
class MaskedBertModel(MaskedBertPreTrainedModel):
    """
    The `MaskedBertModel` class replicates the :class:`~transformers_openvla_oft.BertModel` class
