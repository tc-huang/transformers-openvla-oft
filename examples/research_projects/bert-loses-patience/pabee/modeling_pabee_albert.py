...
from transformers_openvla_oft.models.albert.modeling_albert import (
...
class AlbertModelWithPabee(AlbertModel):
    ...
    def forward(
        ...
        r"""
        Return:
            :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformers_openvla_oft.AlbertConfig`) and inputs:
    ...
    def forward(
        ...
        Returns:
            ...
            Examples::
                ...
                from transformers_openvla_oft import AlbertTokenizer
