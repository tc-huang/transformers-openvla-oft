...
from transformers_openvla_oft.file_utils import add_start_docstrings
from transformers_openvla_oft.modeling_flax_utils import ACT2FN
from transformers_openvla_oft.models.bert.configuration_bert import BertConfig
from transformers_openvla_oft.models.bert.modeling_flax_bert import FlaxBertOnlyMLMHead, FlaxBertPreTrainedModel
...
BERT_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~transformers_openvla_oft.PreTrainedModel`. Check the superclass documentation for the generic
    ...
    Parameters:
        config (:class:`~transformers_openvla_oft.BertConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~transformers_openvla_oft.PreTrainedModel.from_pretrained` method to load the model
            weights.
"""
...
BERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformers_openvla_oft.BertTokenizer`. See
            :meth:`transformers_openvla_oft.PreTrainedTokenizer.encode` and :meth:`transformers_openvla_oft.PreTrainedTokenizer.__call__` for
            details.
        ...
        return_dict (:obj:`bool`, `optional`):
            Whether or not to return a :class:`~transformers_openvla_oft.file_utils.ModelOutput` instead of a plain tuple.
"""
