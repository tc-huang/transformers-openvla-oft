...
from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2 import _compute_mask_indices
...
class Wav2Vec2PreTrainer(Trainer):
    """
    Subclassed :class:`~transformers_openvla_oft.Trainer` for Wav2Vec2-like pretraining. Trainer can decay gumbel softmax temperature during training.
    """
