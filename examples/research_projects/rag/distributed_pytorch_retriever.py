...
from transformers_openvla_oft import RagRetriever
...
class RagPyTorchDistributedRetriever(RagRetriever):
    ...
    Args:
        ...
        index (:class:`~transformers_openvla_oft.models.rag.retrieval_rag.Index`, optional, defaults to the one defined by the configuration):
