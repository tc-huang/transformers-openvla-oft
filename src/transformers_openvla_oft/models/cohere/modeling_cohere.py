...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaMLP Llama->Cohere
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2 Llama->Cohere
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaSdpaAttention Llama->Cohere
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->Cohere
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel with Llama->Cohere
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM with Llama->Cohere
class CohereForCausalLM(CoherePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >> from transformers_openvla_oft import AutoTokenizer, CohereForCausalLM
