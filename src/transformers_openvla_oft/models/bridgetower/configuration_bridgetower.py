...
class BridgeTowerVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BridgeTowerVisionConfig
...
class BridgeTowerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BridgeTowerTextConfig
...
class BridgeTowerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BridgeTowerModel, BridgeTowerConfig
