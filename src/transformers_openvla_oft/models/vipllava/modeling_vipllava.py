...
@dataclass
# Copied from transformers_openvla_oft.models.idefics.modeling_idefics.IdeficsCausalLMOutputWithPast with Idefics->VipLlava
...
# Copied from transformers_openvla_oft.models.llava.modeling_llava.LlavaPreTrainedModel with Llava->VipLlava,llava->vipllava
...
# Copied from transformers_openvla_oft.models.llava.modeling_llava.LlavaForConditionalGeneration with LLAVA->VIPLLAVA,Llava->VipLlava
class VipLlavaForConditionalGeneration(VipLlavaPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, VipLlavaForConditionalGeneration
