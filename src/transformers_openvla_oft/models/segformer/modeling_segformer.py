...
# Copied from transformers_openvla_oft.models.convnext.modeling_convnext.ConvNextDropPath with ConvNext->Segformer
...
class SegformerForSemanticSegmentation(SegformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, SegformerForSemanticSegmentation
