...
class SegformerImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_openvla_oft.models.vit.image_processing_vit.ViTImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
    ...
    # Copied from transformers_openvla_oft.models.beit.image_processing_beit.BeitImageProcessor.reduce_label
    ...
    # Copied from transformers_openvla_oft.models.beit.image_processing_beit.BeitImageProcessor.post_process_semantic_segmentation with Beit->Segformer
