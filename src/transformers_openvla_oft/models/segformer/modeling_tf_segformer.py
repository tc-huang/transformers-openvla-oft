...
# Copied from transformers_openvla_oft.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, TFSegformerForSemanticSegmentation
