...
class UdopProcessor(ProcessorMixin):
    ...
    # Copied from transformers_openvla_oft.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.get_overflowing_images
    ...
    # Copied from transformers_openvla_oft.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.batch_decode
    ...
    # Copied from transformers_openvla_oft.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.decode
    ...
    @property
    # Copied from transformers_openvla_oft.models.layoutlmv3.processing_layoutlmv3.LayoutLMv3Processor.model_input_names
