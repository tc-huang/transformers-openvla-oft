...
# Copied from transformers_openvla_oft.models.maskformer.modeling_maskformer.MaskFormerSinePositionEmbedding with MaskFormer->Mask2Former
...
# Modified from transformers_openvla_oft.models.detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention
...
# Modified from from transformers_openvla_oft.models.detr.modeling_deformable_detr.DeformableDetrEncoder with DeformableDetrEncoder->Mask2FormerPixelDecoderEncoderOnly
...
# Modified from from transformers_openvla_oft.models.detr.modeling_deformable_detr.DeformableDetrModel with DeformableDetrModel->Mask2FormerPixelDecoder
...
# Modified from transformers_openvla_oft.models.detr.modeling_detr.DetrAttention with Detr->Mask2Former
...
# Copied from transformers_openvla_oft.models.maskformer.modeling_maskformer.PredictionBlock with MaskFormer->Mask2Former
...
class Mask2FormerModel(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoImageProcessor, Mask2FormerModel
...
class Mask2FormerForUniversalSegmentation(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, Mask2FormerForUniversalSegmentation
        >>> from PIL import Image
        >>> import requests
        >>> import torch
