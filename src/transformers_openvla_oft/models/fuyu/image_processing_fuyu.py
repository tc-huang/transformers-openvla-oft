...
class FuyuImageProcessor(BaseImageProcessor):
    ...
    def patchify_image(self, image: "torch.Tensor", patch_size: Optional[Dict[str, int]] = None) -> "torch.Tensor":
        ...
        # TODO refer to https://github.com/ArthurZucker/transformers/blob/0f0a3fe5ca5697ee58faeb5b53f049af720b5e98/src/transformers_openvla_oft/models/vit_mae/modeling_vit_mae.py#L871
