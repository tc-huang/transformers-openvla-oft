...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2 with Llama->Gemma
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaSdpaAttention with Llama->Gemma
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaDecoderLayer with LLAMA->GEMMA,Llama->Gemma
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel with LLAMA->GEMMA,Llama->Gemma
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->GEMMA,Llama->Gemma,llama->gemma
class GemmaForCausalLM(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, GemmaForCausalLM
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForSequenceClassification with LLAMA->GEMMA,Llama->Gemma
