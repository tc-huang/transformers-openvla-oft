...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerNorm with T5->LongT5
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseActDense with T5->LongT5
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerFF with T5->LongT5
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Attention with T5->LongT5
...
class LongT5LocalAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Attention.prune_heads
    def prune_heads(self, heads):
        if len(heads) == 0:
            return
        heads, index = find_pruneable_heads_and_indices(
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerSelfAttention with T5->LongT5
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerCrossAttention with T5->LongT5
...
class LongT5PreTrainedModel(PreTrainedModel):
    ...
    @property
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5PreTrainedModel.dummy_inputs
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5PreTrainedModel._shift_right with T5->LongT5
...
class LongT5Stack(LongT5PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Stack.get_input_embeddings
    def get_input_embeddings(self):
        return self.embed_tokens

    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Stack.set_input_embeddings
...
class LongT5Model(LongT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, LongT5Model
...
class LongT5ForConditionalGeneration(LongT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, LongT5ForConditionalGeneration
