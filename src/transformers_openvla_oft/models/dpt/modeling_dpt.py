...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfAttention with ViT->DPT
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfOutput with ViT->DPT
...
class DPTViTAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTAttention.prune_heads
    ...
    # Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTAttention.forward
    def forward(
        self,
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTIntermediate with ViT->DPT
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTOutput with ViT->DPT
...
# copied from transformers_openvla_oft.models.vit.modeling_vit.ViTLayer with ViTConfig->DPTConfig, ViTAttention->DPTViTAttention, ViTIntermediate->DPTViTIntermediate, ViTOutput->DPTViTOutput
...
# copied from transformers_openvla_oft.models.vit.modeling_vit.ViTEncoder with ViTConfig -> DPTConfig, ViTLayer->DPTViTLayer
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTPooler with ViT->DPT
...
class DPTForDepthEstimation(DPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, DPTForDepthEstimation
        >>> import torch
        >>> import numpy as np
...
class DPTForSemanticSegmentation(DPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, DPTForSemanticSegmentation
        >>> from PIL import Image
        >>> import requests
