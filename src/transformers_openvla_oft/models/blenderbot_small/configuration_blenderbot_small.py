...
class BlenderbotSmallConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BlenderbotSmallConfig, BlenderbotSmallModel
...
# Copied from transformers_openvla_oft.models.bart.configuration_bart.BartOnnxConfig
