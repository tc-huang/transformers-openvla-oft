...
# Copied from transformers_openvla_oft.models.blenderbot.modeling_blenderbot.BlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->BlenderbotSmall
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartEncoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotSmallForConditionalGeneration
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotSmallModel
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->BlenderbotSmall
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM with Bart->BlenderbotSmall, facebook/bart-base->facebook/blenderbot_small-90M
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotSmallForCausalLM
