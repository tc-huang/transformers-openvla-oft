...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->TimeSformer
...
class TimesformerModel(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoImageProcessor, TimesformerModel
...
class TimesformerForVideoClassification(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoImageProcessor, TimesformerForVideoClassification
        >>> from huggingface_hub import hf_hub_download
