...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, RagRetriever, TFRagModel
        >>> import torch
        ...
        if encoder_outputs is None:
            if has_to_retrieve:
                ...
                # see https://github.com/huggingface/transformers/blob/main/src/transformers_openvla_oft/models/dpr/modeling_tf_dpr.py#L91
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Adapted from https://github.com/huggingface/transformers/blob/main/src/transformers_openvla_oft/modeling_tf_bart.py
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_openvla_oft import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration
