...
class ClvpEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClvpEncoderConfig, ClvpEncoder
...
class ClvpDecoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClvpDecoderConfig, ClvpDecoder
...
class ClvpConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClvpConfig, ClvpModelForConditionalGeneration
    ...
    >>> from transformers_openvla_oft import ClvpEncoderConfig, ClvpDecoderConfig
