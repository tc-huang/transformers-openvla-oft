...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->clvp, image_loss->speech_loss
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRMSNorm with Llama->Clvp
...
class ClvpSelfAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention._shape
...
# Copied from transformers_openvla_oft.models.gpt2.modeling_gpt2.GPT2MLP with GPT2->ClvpDecoderMLP
...
class ClvpForCausalLM(ClvpPreTrainedModel):
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.gpt2.modeling_gpt2.GPT2LMHeadModel._reorder_cache
    def _reorder_cache(
