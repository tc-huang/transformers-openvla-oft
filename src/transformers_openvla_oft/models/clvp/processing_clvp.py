...
class ClvpProcessor(ProcessorMixin):
    ...
    # Copied from transformers_openvla_oft.models.whisper.processing_whisper.WhisperProcessor.batch_decode with Whisper->Clvp
    ...
    # Copied from transformers_openvla_oft.models.whisper.processing_whisper.WhisperProcessor.decode with Whisper->Clvp
