...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->NllbMoe,key_value_states->encoder_hidden_states
...
NLLB_MOE_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, NllbMoeForConditionalGeneration
...
class NllbMoeModel(NllbMoePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, NllbMoeModel
