...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100, MBART->M2M100
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100, MBART->M2M100
...
M2M_100_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, M2M100ForConditionalGeneration
