...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfOutput with ViT->Vilt
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTIntermediate with ViT->Vilt
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTOutput with ViT->Vilt
...
class ViltModel(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import ViltProcessor, ViltModel
...
class ViltForMaskedLM(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import ViltProcessor, ViltForMaskedLM
        >>> import requests
        >>> from PIL import Image
        >>> import re
        >>> import torch
...
class ViltForQuestionAnswering(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import ViltProcessor, ViltForQuestionAnswering
        >>> import requests
        >>> from PIL import Image
...
class ViltForImageAndTextRetrieval(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import ViltProcessor, ViltForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class ViltForImagesAndTextClassification(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import ViltProcessor, ViltForImagesAndTextClassification
        >>> import requests
        >>> from PIL import Image
