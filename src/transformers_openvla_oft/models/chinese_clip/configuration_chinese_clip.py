...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from transformers_openvla_oft import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ChineseCLIPConfig, ChineseCLIPModel
