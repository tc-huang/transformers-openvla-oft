...
from transformers_openvla_oft import OlmoConfig, OlmoForCausalLM
...
```
python src/transformers_openvla_oft/models/olmo/convert_olmo_weights_to_hf.py \
...
```py
from transformers_openvla_oft import OlmoForCausalLM, AutoTokenizer
