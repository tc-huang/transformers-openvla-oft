...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Olmo
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaLinearScalingRotaryEmbedding with Llama->Olmo
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaDynamicNTKScalingRotaryEmbedding with Llama->Olmo
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.apply_rotary_pos_emb
...
class OlmoAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaAttention.__init__ with Llama->Olmo
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaAttention._init_rope with Llama->Olmo
    def _init_rope(self):
...
class OlmoFlashAttention2(OlmoAttention):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward with Llama->Olmo
...
class OlmoDecoderLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->Olmo
...
class OlmoModel(OlmoPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel.forward
    def forward(
        self,
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel._update_causal_mask
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->OLMO,Llama->Olmo
class OlmoForCausalLM(OlmoPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, OlmoForCausalLM
