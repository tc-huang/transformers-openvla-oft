...
from transformers_openvla_oft.models.superpoint.configuration_superpoint import SuperPointConfig
...
class SuperPointForKeypointDetection(SuperPointPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, SuperPointForKeypointDetection
        >>> import torch
