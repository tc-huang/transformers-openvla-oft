...
# Copied from transformers_openvla_oft.models.owlvit.image_processing_owlvit._upcast
def _upcast(t):
...
# Copied from transformers_openvla_oft.models.owlvit.image_processing_owlvit.box_area
def box_area(boxes):
    """
...
# Copied from transformers_openvla_oft.models.owlvit.image_processing_owlvit.box_iou
...
class Owlv2ImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_openvla_oft.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process_object_detection
    ...
    # Copied from transformers_openvla_oft.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process_image_guided_detection
