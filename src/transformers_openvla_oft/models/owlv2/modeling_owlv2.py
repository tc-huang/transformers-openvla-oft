...
if is_vision_available():
    from transformers_openvla_oft.image_transforms import center_to_corners_format
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.contrastive_loss with clip->owlv2
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->owlv2
...
@dataclass
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTImageGuidedObjectDetectionOutput with OwlViT->Owlv2,OWL-ViT->OWLv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTVisionEmbeddings with OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTTextEmbeddings with OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTAttention with OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->Owlv2
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTPreTrainedModel with OwlViT->Owlv2,owlvit->owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTEncoder with OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTTextTransformer with OWLVIT->OWLV2,OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTTextModel with google/owlvit-base-patch32->google/owlv2-base-patch16, OWLVIT->OWLV2,OwlViT->Owlv2
class Owlv2TextModel(Owlv2PreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, Owlv2TextModel
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTVisionTransformer with OWLVIT->OWLV2,OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTVisionModel with OWLVIT->OWLV2,OwlViT->Owlv2,google/owlvit-base-patch32->google/owlv2-base-patch16
class Owlv2VisionModel(Owlv2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, Owlv2VisionModel
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTModel with google/owlvit-base-patch32->google/owlv2-base-patch16-ensemble, OWLVIT->OWLV2,OwlViT->Owlv2,owlvit->owlv2,OWL-ViT->OWLv2
class Owlv2Model(Owlv2PreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, Owlv2Model
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTBoxPredictionHead with OwlViT->Owlv2
...
# Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTClassPredictionHead with OwlViT->Owlv2
...
class Owlv2ForObjectDetection(Owlv2PreTrainedModel):
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.normalize_grid_corner_coordinates
    ...
    @lru_cache(maxsize=2)
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.compute_box_bias
    ...
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.box_predictor
    def box_predictor(
        self,
    ...
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.class_predictor
    def class_predictor(
        self,
        image_feats: torch.FloatTensor,
    ...
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.image_text_embedder with owlvit->owlv2
    ...
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.image_embedder with owlvit->owlv2, OwlViTModel->Owlv2Model
    def image_embedder(
        self,
        pixel_values: torch.FloatTensor,
        output_attentions: Optional[bool] = None,
    ...
    # Copied from transformers_openvla_oft.models.owlvit.modeling_owlvit.OwlViTForObjectDetection.embed_image_query
    ...
    def image_guided_detection(
        ...
        >>> import torch
        >>> import numpy as np
        >>> from transformers_openvla_oft import AutoProcessor, Owlv2ForObjectDetection
        >>> from transformers_openvla_oft.utils.constants import OPENAI_CLIP_MEAN, OPENAI_CLIP_STD
