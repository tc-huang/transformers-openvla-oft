...
class Owlv2Processor(ProcessorMixin):
    ...
    # Copied from transformers_openvla_oft.models.owlvit.processing_owlvit.OwlViTProcessor.__call__ with OWLViT->OWLv2
    ...
    # Copied from transformers_openvla_oft.models.owlvit.processing_owlvit.OwlViTProcessor.post_process_object_detection with OWLViT->OWLv2
    ...
    # Copied from transformers_openvla_oft.models.owlvit.processing_owlvit.OwlViTProcessor.post_process_image_guided_detection with OWLViT->OWLv2
    ...
    # Copied from transformers_openvla_oft.models.owlvit.processing_owlvit.OwlViTProcessor.batch_decode
    ...
    # Copied from transformers_openvla_oft.models.owlvit.processing_owlvit.OwlViTProcessor.decode
