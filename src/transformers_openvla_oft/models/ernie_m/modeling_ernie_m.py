...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention with Bert->ErnieM,self.value->self.v_proj,self.key->self.k_proj,self.query->self.q_proj
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPooler with Bert->ErnieM
...
class ErnieMForSequenceClassification(ErnieMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForSequenceClassification.__init__ with Bert->ErnieM,bert->ernie_m
    def __init__(self, config):
...
class ErnieMForMultipleChoice(ErnieMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForMultipleChoice.__init__ with Bert->ErnieM,bert->ernie_m
    def __init__(self, config):
        super().__init__(config)
...
class ErnieMForTokenClassification(ErnieMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForTokenClassification.__init__ with Bert->ErnieM,bert->ernie_m
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
class ErnieMForQuestionAnswering(ErnieMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForQuestionAnswering.__init__ with Bert->ErnieM,bert->ernie_m
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
