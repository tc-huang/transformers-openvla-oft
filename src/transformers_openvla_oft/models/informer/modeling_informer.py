...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesFeatureEmbedder with TimeSeries->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesStdScaler with TimeSeriesTransformer->Informer,TimeSeries->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesMeanScaler with TimeSeriesTransformer->Informer,TimeSeries->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesNOPScaler with TimeSeriesTransformer->Informer,TimeSeries->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.weighted_average
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.nll
...
# Copied from transformers_openvla_oft.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesValueEmbedding with TimeSeries->Info
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesTransformerDecoder with TimeSeriesTransformer->Informer,TimeSeriesTransformerConfig->InformerConfig,time-series-transformer->informer,Transformer->Informer,TimeSeries->Informer
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesTransformerModel with TimeSeriesTransformer->Informer,TIME_SERIES_TRANSFORMER->INFORMER,time-series-transformer->informer,TimeSeries->Informer
class InformerModel(InformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from transformers_openvla_oft import InformerModel
...
# Copied from transformers_openvla_oft.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesTransformerForPrediction with TimeSeriesTransformer->Informer,TIME_SERIES_TRANSFORMER->INFORMER,time-series-transformer->informer
class InformerForPrediction(InformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_openvla_oft import InformerForPrediction
