...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaSelfOutput with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaAttention with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaLayer with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEncoder with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Camembert
...
class CamembertModel(CamembertPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.__init__ with Bert->Camembert
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaForSequenceClassification with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaForMultipleChoice with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaForTokenClassification with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaForQuestionAnswering with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaForCausalLM with Roberta->Camembert, ROBERTA->CAMEMBERT, FacebookAI/roberta-base->almanach/camembert-base
class CamembertForCausalLM(CamembertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, CamembertForCausalLM, AutoConfig
        >>> import torch
