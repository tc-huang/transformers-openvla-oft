...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->Falcon
...
# copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaLinearScalingRotaryEmbedding with Llama->Falcon
...
# copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaDynamicNTKScalingRotaryEmbedding with Llama->Falcon
# TODO @joao no longer copied from LLama after static cache, fix me (copied -> Copied)
...
def build_alibi_tensor(attention_mask: torch.Tensor, num_heads: int, dtype: torch.dtype) -> torch.Tensor:
    ...
    # https://github.com/huggingface/transformers/blob/f681437203baa7671de3174b0fa583c349d9d5e1/src/transformers_openvla_oft/models/t5/modeling_t5.py#L527
    arange_tensor = ((attention_mask.cumsum(dim=-1) - 1) * attention_mask)[:, None, :]
    alibi = slopes[..., None].bfloat16() * arange_tensor
    return alibi.reshape(batch_size * num_heads, 1, seq_length).to(dtype)


# Copied from transformers_openvla_oft.models.bloom.modeling_bloom.dropout_add
...
class FalconAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaAttention._init_rope with Llama->Falcon
    def _init_rope(self):
    ...
    # Copied from transformers_openvla_oft.models.bloom.modeling_bloom.BloomAttention._merge_heads
...
class FalconPreTrainedModel(PreTrainedModel):
    ...
    # Adapted from transformers_openvla_oft.modeling_utils.PreTrainedModel._check_and_enable_sdpa
    @classmethod
