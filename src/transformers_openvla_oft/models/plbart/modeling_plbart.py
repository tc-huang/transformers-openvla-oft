...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.shift_tokens_right
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->PLBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->PLBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartEncoderLayer with Bart->PLBart, BART->PLBART
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderLayer with Bart->PLBart, BART->PLBART
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartClassificationHead with Bart->PLBart
...
PLBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, PLBartForConditionalGeneration
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartEncoder with Bart->PLBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoder with Bart->PLBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->PLBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM with Bart->PLBart, facebook/bart-base->uclanlp/plbart-base
class PLBartForCausalLM(PLBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PLBartForCausalLM
