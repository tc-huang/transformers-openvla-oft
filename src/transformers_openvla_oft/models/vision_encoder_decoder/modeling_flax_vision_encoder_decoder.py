...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    another one as decoder module when created with the :meth*~transformers_openvla_oft.FlaxAutoModel.from_pretrained* class method
    for the encoder and :meth*~transformers_openvla_oft.FlaxAutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def encode(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxVisionEncoderDecoderModel
