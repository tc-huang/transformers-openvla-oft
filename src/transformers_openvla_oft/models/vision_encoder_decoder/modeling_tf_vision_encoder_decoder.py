...
# Copied from transformers_openvla_oft.models.encoder_decoder.modeling_tf_encoder_decoder.shift_tokens_right
...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, AutoTokenizer, TFVisionEncoderDecoderModel
