...
class VisionEncoderDecoderModel(PreTrainedModel):
    ...
    :meth*~transformers_openvla_oft.AutoModel.from_pretrained* class method for the encoder and
    :meth*~transformers_openvla_oft.AutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers_openvla_oft import VisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        ...
        if from_tf:
            from transformers_openvla_oft import TFVisionEncoderDecoderModel
            ...
            #   (the change in `src/transformers_openvla_oft/modeling_tf_utils.py`)
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, VisionEncoderDecoderModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch
