...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import ClapConfig, ClapModel
    ...
    >>> from transformers_openvla_oft import ClapTextConfig, ClapAudioConfig
