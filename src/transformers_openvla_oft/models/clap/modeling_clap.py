...
@dataclass
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->Clap
...
@dataclass
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPOutput with CLIP->Clap, vision->audio, Vision->Audio, image->audio
...
# Adapted from transformers_openvla_oft.models.swin.modeling_swin.SwinDropPath
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinSelfAttention with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinSelfOutput with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinAttention with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinIntermediate with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinOutput with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinLayer with SwinDropPath->ClapDropPath, Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinStage with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinPatchMerging with Swin->ClapAudio
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->ClapText, persistent=False->persistent=True
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention with Bert->ClapText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertAttention with Bert->ClapText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertLayer with Bert->ClapText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertEncoder with Bert->ClapText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPooler
...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoProcessor, ClapAudioModel
...
class ClapTextModel(ClapPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.__init__ with Bert->ClapText
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoFeatureExtractor, ClapModel
        >>> import torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from transformers_openvla_oft import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from transformers_openvla_oft import ClapAudioModelWithProjection, ClapProcessor
