...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_openvla_oft import BarkSemanticConfig, BarkSemanticModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_openvla_oft import BarkCoarseConfig, BarkCoarseModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_openvla_oft import BarkFineConfig, BarkFineModel
