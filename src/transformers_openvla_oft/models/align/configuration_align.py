...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AlignConfig, AlignModel
    ...
    >>> from transformers_openvla_oft import AlignTextConfig, AlignVisionConfig
