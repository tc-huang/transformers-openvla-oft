...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.round_filters with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.correct_pad
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.EfficientNetEmbeddings with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.EfficientNetDepthwiseConv2d with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.EfficientNetExpansionLayer with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.EfficientNetDepthwiseLayer with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.efficientnet.modeling_efficientnet.EfficientNetSqueezeExciteLayer with EfficientNet->AlignVision
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertEmbeddings with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfOutput with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertAttention with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertLayer with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertEncoder with Bert->AlignText
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPooler with Bert -> AlignText
...
class AlignTextModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, AlignTextModel
...
class AlignVisionModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, AlignVisionModel
...
class AlignModel(AlignPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, AlignModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, AlignModel
