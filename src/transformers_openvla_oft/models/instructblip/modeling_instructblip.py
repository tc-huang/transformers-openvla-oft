...
@dataclass
# Copied from transformers_openvla_oft.models.blip_2.modeling_blip_2.Blip2ForConditionalGenerationModelOutput with Blip2->InstructBlip
...
# Copied from transformers_openvla_oft.models.blip.modeling_blip.BlipVisionEmbeddings with Blip->InstructBlip
...
# Copied from transformers_openvla_oft.models.blip_2.modeling_blip_2.Blip2Attention with Blip2->InstructBlip
...
# Copied from transformers_openvla_oft.models.blip.modeling_blip.BlipMLP
...
# Copied from transformers_openvla_oft.models.blip.modeling_blip.BlipEncoderLayer with Blip->InstructBlip
...
class InstructBlipPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.blip_2.modeling_blip_2.Blip2PreTrainedModel._init_weights with Blip2->InstructBlip
...
# Copied from transformers_openvla_oft.models.blip.modeling_blip.BlipEncoder with Blip->InstructBlip
...
# Copied from transformers_openvla_oft.models.blip.modeling_blip.BlipVisionModel with Blip->InstructBlip, BLIP->INSTRUCTBLIP
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfOutput with Bert->InstructBlipQFormer
...
# Copied from transformers_openvla_oft.models.blip_2.modeling_blip_2.Blip2QFormerAttention with Blip2->InstructBlip
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->InstructBlipQFormer
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->InstructBlipQFormer
...
# Copied from transformers_openvla_oft.models.blip_2.modeling_blip_2.Blip2QFormerEncoder with Blip2->InstructBlip
...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import InstructBlipProcessor, InstructBlipForConditionalGeneration
        >>> import torch
