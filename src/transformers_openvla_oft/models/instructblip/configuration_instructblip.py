...
class InstructBlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import InstructBlipVisionConfig, InstructBlipVisionModel
...
class InstructBlipQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import InstructBlipQFormerConfig, InstructBlipQFormerModel
