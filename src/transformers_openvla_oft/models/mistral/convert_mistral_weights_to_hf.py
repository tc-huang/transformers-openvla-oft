...
```
python src/transformers_openvla_oft/models/mistral/convert_mistral_weights_to_hf.py \
...
```py
from transformers_openvla_oft import MistralForCausalLM, LlamaTokenizer
