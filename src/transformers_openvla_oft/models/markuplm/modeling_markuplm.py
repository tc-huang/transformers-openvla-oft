...
class MarkupLMEmbeddings(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEmbeddings.create_position_ids_from_inputs_embeds
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfOutput with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertLMPredictionHead with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOnlyMLMHead with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertAttention with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertLayer with Bert->MarkupLM
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertEncoder with Bert->MarkupLM
...
class MarkupLMPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->MarkupLM
...
class MarkupLMModel(MarkupLMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.__init__ with Bert->MarkupLM
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, MarkupLMModel
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.prepare_inputs_for_generation
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel._reorder_cache
...
class MarkupLMForQuestionAnswering(MarkupLMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForQuestionAnswering.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, MarkupLMForQuestionAnswering
        >>> import torch
...
class MarkupLMForTokenClassification(MarkupLMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForTokenClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, AutoModelForTokenClassification
        >>> import torch
...
class MarkupLMForSequenceClassification(MarkupLMPreTrainedModel):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertForSequenceClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, AutoModelForSequenceClassification
        >>> import torch
