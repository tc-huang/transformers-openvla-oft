...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->FNet
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->FNet
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPooler with Bert->FNet
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->FNet
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOnlyNSPHead with Bert->FNet
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPreTrainingHeads with Bert->FNet
...
class FNetForPreTraining(FNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, FNetForPreTraining
        >>> import torch
...
class FNetForNextSentencePrediction(FNetPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, FNetForNextSentencePrediction
        >>> import torch
