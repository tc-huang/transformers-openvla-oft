...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Kosmos2
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention with CLIP->Kosmos2Vision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->Kosmos2Vision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->Kosmos2Vision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->Kosmos2Vision
...
# Similar to `transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer` but without docstring for `forward`
class Kosmos2VisionTransformer(nn.Module):
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer.__init__ with CLIPVision->Kosmos2Vision,CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2Vision
    def __init__(self, config: Kosmos2VisionConfig):
        super().__init__()
        self.config = config
...
# Similar to `transformers_openvla_oft.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding` but allowing to pass `position_ids`
class Kosmos2TextSinusoidalPositionalEmbedding(nn.Module):
    """This module produces sinusoidal positional embeddings of any length."""

    # Copied from transformers_openvla_oft.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.__init__
    ...
    # Copied from transformers_openvla_oft.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.make_weights
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.get_embedding
    ...
    # Copied from transformers_openvla_oft.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.create_position_ids_from_inputs_embeds
...
class KosmosTextAttention(nn.Module):
    ...
    # Similar to transformers_openvla_oft.models.bart.modeling_bart.BartAttention.__init__ except an additional `inner_attn_ln`.
    def __init__(
        self,
        config,
        embed_dim: int,
...
class Kosmos2VisionModel(Kosmos2PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
    def __init__(self, config: Kosmos2VisionConfig):
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionModel.get_input_embeddings with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
...
class Kosmos2TextForCausalLM(Kosmos2PreTrainedModel):
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.umt5.modeling_umt5.UMT5ForConditionalGeneration._reorder_cache
...
class Kosmos2Model(Kosmos2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, Kosmos2Model
