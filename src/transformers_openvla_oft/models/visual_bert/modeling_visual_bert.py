...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfOutput with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPooler with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertLMPredictionHead with Bert->VisualBert
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertPreTrainingHeads with Bert->VisualBert
...
class VisualBertModel(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from transformers_openvla_oft import AutoTokenizer, VisualBertModel
        import torch
...
class VisualBertForPreTraining(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from transformers_openvla_oft import AutoTokenizer, VisualBertForPreTraining
...
class VisualBertForMultipleChoice(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from transformers_openvla_oft import AutoTokenizer, VisualBertForMultipleChoice
        import torch
...
class VisualBertForQuestionAnswering(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from transformers_openvla_oft import AutoTokenizer, VisualBertForQuestionAnswering
        import torch
...
class VisualBertForVisualReasoning(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from transformers_openvla_oft import AutoTokenizer, VisualBertForVisualReasoning
        import torch
...
class VisualBertForRegionToPhraseAlignment(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from transformers_openvla_oft import AutoTokenizer, VisualBertForRegionToPhraseAlignment
        import torch
