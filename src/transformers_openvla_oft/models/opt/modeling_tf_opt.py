...
# Copied from transformers_openvla_oft.models.bart.modeling_tf_bart.TFBartAttention with Bart->OPT
...
class TFOPTPreTrainedModel(TFPreTrainedModel):
    """
    TFOPT Pretrained Model that inheritates from transformers_openvla_oft.TFPreTrainedModel
