...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->OPT
...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartModel with Bart->OPT
