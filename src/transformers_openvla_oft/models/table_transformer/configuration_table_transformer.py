...
class TableTransformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import TableTransformerModel, TableTransformerConfig
    ...
    # Copied from transformers_openvla_oft.models.detr.configuration_detr.DetrConfig.__init__
    def __init__(
        self,
        use_timm_backbone=True,
...
# Copied from transformers_openvla_oft.models.detr.configuration_detr.DetrOnnxConfig
