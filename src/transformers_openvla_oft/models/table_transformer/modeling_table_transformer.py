...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrDecoderOutput with DETR->TABLE_TRANSFORMER,Detr->TableTransformer
...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrModelOutput with DETR->TABLE_TRANSFORMER,Detr->TableTransformer
...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrObjectDetectionOutput with Detr->TableTransformer,DetrImageProcessor->DetrImageProcessor
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.replace_batch_norm with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvEncoder with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvModel with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrSinePositionEmbedding with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLearnedPositionEmbedding with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.build_position_encoding with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrAttention with DETR->TABLE_TRANSFORMER,Detr->TableTransformer
...
class TableTransformerEncoderLayer(nn.Module):
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrEncoderLayer.__init__ with Detr->TableTransformer
...
class TableTransformerDecoderLayer(nn.Module):
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrDecoderLayer.__init__ with Detr->TableTransformer
    def __init__(self, config: TableTransformerConfig):
        super().__init__()
        self.embed_dim = config.d_model
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrClassificationHead with Detr->TableTransformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrDecoder with DETR->TABLE_TRANSFORMER,Detr->TableTransformer
...
class TableTransformerModel(TableTransformerPreTrainedModel):
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrModel.__init__ with Detr->TableTransformer
    def __init__(self, config: TableTransformerConfig):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, TableTransformerModel
...
class TableTransformerForObjectDetection(TableTransformerPreTrainedModel):
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrForObjectDetection.__init__ with Detr->TableTransformer
    def __init__(self, config: TableTransformerConfig):
        super().__init__(config)
    ...
    @torch.jit.unused
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrForObjectDetection._set_aux_loss
    ...
    def forward(
        ...
        ```python
        >>> from huggingface_hub import hf_hub_download
        >>> from transformers_openvla_oft import AutoImageProcessor, TableTransformerForObjectDetection
        >>> import torch
        >>> from PIL import Image
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss with Detr->TableTransformer,detr->table_transformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMLPPredictionHead with Detr->TableTransformer,detr->table_transformer
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrHungarianMatcher with Detr->TableTransformer
