...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfOutput with ViT->VideoMAE
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTAttention with ViT->VideoMAE
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTIntermediate ViT->VideoMAE
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTOutput ViT->VideoMAE
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTLayer with ViT->VideoMAE
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTEncoder with ViT->VideoMAE
...
class VideoMAEModel(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoImageProcessor, VideoMAEModel
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, VideoMAEForPreTraining
        >>> import numpy as np
        >>> import torch
...
class VideoMAEForVideoClassification(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoImageProcessor, VideoMAEForVideoClassification
        >>> from huggingface_hub import hf_hub_download
