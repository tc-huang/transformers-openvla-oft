...
class IdeficsForVisionText2Text(IdeficsPreTrainedModel):
    ...
    def tie_weights(self):
        """
        Overwrite `transformers_openvla_oft.modeling_utils.PreTrainedModel.tie_weights` to handle the case of
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, IdeficsForVisionText2Text
