...
# Adapted from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings
class IdeficsVisionEmbeddings(nn.Module):
    ...
    # Heavily inspired from https://github.com/huggingface/transformers/blob/v4.33.0/src/transformers_openvla_oft/models/vit/modeling_vit.py#L82
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention with CLIP->IdeficsVision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->IdeficsVision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->IdeficsVision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->IdeficsVision
...
# Adapted from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer
class IdeficsVisionTransformer(nn.Module):
    ...
    # Adapted from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer.forward
    def forward(
        self,
