...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->x_clip
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->XCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->XCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention with CLIP->XCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->XCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->XCLIP
...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->XCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->XCLIP
...
class XCLIPTextModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, XCLIPTextModel
...
class XCLIPVisionModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoProcessor, XCLIPVisionModel
