...
class EfficientNetImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_openvla_oft.models.vit.image_processing_vit.ViTImageProcessor.resize with PILImageResampling.BILINEAR->PILImageResampling.NEAREST
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
