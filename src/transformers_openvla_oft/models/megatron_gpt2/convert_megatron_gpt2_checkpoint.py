...
# PYTHONPATH=/tmp/Megatron-LM python src/transformers_openvla_oft/models/megatron_gpt2/convert_megatron_gpt2_checkpoint.py ...
#
...
from transformers_openvla_oft import AutoTokenizer, GPT2Config
