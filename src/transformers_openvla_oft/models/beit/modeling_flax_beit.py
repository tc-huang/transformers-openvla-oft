...
FLAX_BEIT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoImageProcessor, FlaxBeitModel
...
FLAX_BEIT_MLM_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoImageProcessor, BeitForMaskedImageModeling
    >>> from PIL import Image
    >>> import requests
...
FLAX_BEIT_CLASSIF_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoImageProcessor, FlaxBeitForImageClassification
    >>> from PIL import Image
    >>> import requests
