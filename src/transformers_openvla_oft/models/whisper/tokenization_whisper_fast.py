...
class WhisperTokenizerFast(PreTrainedTokenizerFast):
    ...
    # Copied from transformers_openvla_oft.models.gpt2.tokenization_gpt2_fast.GPT2TokenizerFast._batch_encode_plus
    ...
    # Copied from transformers_openvla_oft.models.gpt2.tokenization_gpt2_fast.GPT2TokenizerFast._encode_plus
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._decode_with_timestamps
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._compute_offsets
    ...
    @lru_cache
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.timestamp_ids
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._preprocess_token_ids
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._filter_timestamp_ids
    def _filter_timestamp_ids(self, token_ids):
        return re.sub(self.timestamp_pat, "", token_ids)

    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.decode
    def decode(
        self,
        token_ids,
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._normalize
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._basic_normalize
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.normalize
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.basic_normalize
    ...
    @property
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.prefix_tokens
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.build_inputs_with_special_tokens
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.get_special_tokens_mask
    ...
    @property
    # Copied from transformers_openvla_oft.models.gpt2.tokenization_gpt2.GPT2Tokenizer.default_chat_template
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.get_decoder_prompt_ids
    ...
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer.get_prompt_ids
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.whisper.tokenization_whisper.WhisperTokenizer._strip_prompt
