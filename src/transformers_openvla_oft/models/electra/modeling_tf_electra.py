...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertAttention with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertOutput with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertLayer with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertPooler with Bert->Electra
...
# Copied from transformers_openvla_oft.models.albert.modeling_tf_albert.TFAlbertEmbeddings with Albert->Electra
class TFElectraEmbeddings(keras.layers.Layer):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertEmbeddings.call
    def call(
        self,
...
class TFElectraForPreTraining(TFElectraPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_openvla_oft import AutoTokenizer, TFElectraForPreTraining
