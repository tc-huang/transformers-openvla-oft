...
class FlaxElectraEmbeddings(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertEmbeddings.__call__
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertSelfAttention with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertSelfOutput with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertAttention with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertIntermediate with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertOutput with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertLayer with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertLayerCollection with Bert->Electra
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertEncoder with Bert->Electra
...
class FlaxElectraPreTrainedModel(FlaxPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertPreTrainedModel.init_weights
...
FLAX_ELECTRA_FOR_PRETRAINING_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, FlaxElectraForPreTraining
...
# Copied from transformers_openvla_oft.models.bert.modeling_flax_bert.FlaxBertForCausalLM with Bert->Electra
