...
# copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaPooler with Roberta->Mega
...
class MegaForCausalLM(MegaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, MegaForCausalLM, AutoConfig
        >>> import torch
...
# copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Mega
