...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrObjectDetectionOutput with Detr->ConditionalDetr
...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrSegmentationOutput with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.replace_batch_norm with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvEncoder
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvModel with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLearnedPositionEmbedding with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.build_position_encoding with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrAttention
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrEncoderLayer with DetrEncoderLayer->ConditionalDetrEncoderLayer,DetrConfig->ConditionalDetrConfig
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrClassificationHead with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMLPPredictionHead with DetrMLPPredictionHead->MLP
class MLP(nn.Module):
    """
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrPreTrainedModel with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrEncoder with Detr->ConditionalDetr,DETR->ConditionalDETR
...
class ConditionalDetrForSegmentation(ConditionalDetrPreTrainedModel):
    ...
    def forward(
        ...
        ... )
        >>> from transformers_openvla_oft.image_transforms import rgb_to_id
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMaskHeadSmallConv with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMHAttentionMap with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.dice_loss
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.sigmoid_focal_loss
...
class ConditionalDetrLoss(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss.__init__
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss.loss_labels
    ...
    @torch.no_grad()
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss.loss_cardinality
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss.loss_boxes
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss.loss_masks
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss._get_source_permutation_idx
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss._get_target_permutation_idx
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss.get_loss
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss.forward
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMLPPredictionHead with Detr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrHungarianMatcher with DeformableDetr->ConditionalDetr
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr._upcast
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.box_area
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.box_iou
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.generalized_box_iou
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr._max_by_axis
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.NestedTensor
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.nested_tensor_from_tensor_list
