...
from transformers_openvla_oft import FastSpeech2ConformerHifiGan, FastSpeech2ConformerHifiGanConfig, logging


logging.set_verbosity_info()
logger = logging.get_logger("transformers_openvla_oft.models.FastSpeech2Conformer")
