...
# Copied from transformers_openvla_oft.models.speecht5.modeling_speecht5.SpeechT5BatchNormConvLayer
...
# Copied from transformers_openvla_oft.models.speecht5.modeling_speecht5.SpeechT5HifiGan with SpeechT5->FastSpeech2Conformer
