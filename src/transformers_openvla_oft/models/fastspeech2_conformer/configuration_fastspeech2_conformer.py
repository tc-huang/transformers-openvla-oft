...
class FastSpeech2ConformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FastSpeech2ConformerModel, FastSpeech2ConformerConfig
...
class FastSpeech2ConformerHifiGanConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FastSpeech2ConformerHifiGan, FastSpeech2ConformerHifiGanConfig
