...
# Copied from transformers_openvla_oft.models.gemma.modeling_gemma.GemmaRMSNorm with Gemma->RecurrentGemma
...
class RecurrentGemmaRotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # Copied from transformers_openvla_oft.models.gemma.modeling_gemma.GemmaRotaryEmbedding.forward with Gemma->RecurrentGemma
...
class RecurrentGemmaModel(RecurrentGemmaPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel.get_input_embeddings
    def get_input_embeddings(self):
        return self.embed_tokens

    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaModel.set_input_embeddings
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->RECURRENTGEMMA,Llama->RecurrentGemma,llama->gemma
class RecurrentGemmaForCausalLM(RecurrentGemmaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,  # for now we need this for generation
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, RecurrentGemmaForCausalLM
