...
@dataclass
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatEncoderOutput with Nat->Dinat
...
@dataclass
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatModelOutput with Nat->Dinat
...
@dataclass
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatImageClassifierOutput with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatEmbeddings with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatPatchEmbeddings with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatDownsampler with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->Dinat
...
class NeighborhoodAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.nat.modeling_nat.NeighborhoodAttention.transpose_for_scores with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NeighborhoodAttentionOutput
...
class NeighborhoodAttentionModule(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.nat.modeling_nat.NeighborhoodAttentionModule.prune_heads
    ...
    # Copied from transformers_openvla_oft.models.nat.modeling_nat.NeighborhoodAttentionModule.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        output_attentions: Optional[bool] = False,
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatIntermediate with Nat->Dinat
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatOutput with Nat->Dinat
...
class DinatStage(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.nat.modeling_nat.NatStage.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        output_attentions: Optional[bool] = False,
...
class DinatEncoder(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.nat.modeling_nat.NatEncoder.forward with Nat->Dinat
    def forward(
        self,
        hidden_states: torch.Tensor,
        output_attentions: Optional[bool] = False,
...
# Copied from transformers_openvla_oft.models.nat.modeling_nat.NatModel with Nat->Dinat, NAT->DINAT
