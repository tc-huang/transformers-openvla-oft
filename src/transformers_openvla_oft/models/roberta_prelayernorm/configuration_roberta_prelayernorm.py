...
# Copied from transformers_openvla_oft.models.roberta.configuration_roberta.RobertaConfig with FacebookAI/roberta-base->andreasmadsen/efficient_mlm_m0.40,RoBERTa->RoBERTa-PreLayerNorm,Roberta->RobertaPreLayerNorm,roberta->roberta-prelayernorm
class RobertaPreLayerNormConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import RobertaPreLayerNormConfig, RobertaPreLayerNormModel
...
# Copied from transformers_openvla_oft.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->RobertaPreLayerNorm
