...
class ReformerForMaskedLM(ReformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_openvla_oft import AutoTokenizer, ReformerForMaskedLM
...
class ReformerForSequenceClassification(ReformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_openvla_oft import AutoTokenizer, ReformerForSequenceClassification
