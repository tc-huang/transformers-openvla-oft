...
from transformers_openvla_oft import FSMTConfig, FSMTForConditionalGeneration
from transformers_openvla_oft.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from transformers_openvla_oft.tokenization_utils_base import TOKENIZER_CONFIG_FILE
from transformers_openvla_oft.utils import WEIGHTS_NAME, logging
