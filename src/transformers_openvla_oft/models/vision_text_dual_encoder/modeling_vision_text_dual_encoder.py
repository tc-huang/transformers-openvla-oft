...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss
...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import VisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import VisionTextDualEncoderModel, AutoImageProcessor
