...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Speech2Text
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Speech2Text, MBART->SPEECH_TO_TEXT
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Speech2Text, MBART->SPEECH_TO_TEXT
...
class Speech2TextModel(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ...
         ```python
         >>> import torch
         >>> from transformers_openvla_oft import Speech2TextModel, AutoFeatureExtractor
