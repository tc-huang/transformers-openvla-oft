...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.contrastive_loss with clip->owlvit
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->owlvit
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->OwlViT
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->OwlViT
...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, OwlViTTextModel
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, OwlViTModel
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from transformers_openvla_oft import AutoProcessor, OwlViTForObjectDetection
