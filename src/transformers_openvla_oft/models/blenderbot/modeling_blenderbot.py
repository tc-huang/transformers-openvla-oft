...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Blenderbot
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Blenderbot, MBART->BLENDERBOT
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Blenderbot, MBART->BLENDERBOT
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotForConditionalGeneration
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotModel
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->Blenderbot
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM with Bart->Blenderbot, facebook/bart-base->facebook/blenderbot-400M-distill
class BlenderbotForCausalLM(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, BlenderbotForCausalLM
