...
# Copied from transformers_openvla_oft.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from transformers_openvla_oft.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from transformers_openvla_oft.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```py
    >>> from transformers_openvla_oft import AutoTokenizer, TFBlenderbotForConditionalGeneration
