...
class DistilBertFlashAttention2(MultiHeadSelfAttention):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2._flash_attention_forward with causal=True->causal=False
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2._upad_input with num_heads->n_heads
...
class DistilBertForMultipleChoice(DistilBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, DistilBertForMultipleChoice
        >>> import torch
