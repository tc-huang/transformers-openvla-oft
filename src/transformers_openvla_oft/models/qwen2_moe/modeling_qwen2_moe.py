...
# Copied from transformers_openvla_oft.models.mixtral.modeling_mixtral.load_balancing_loss_func
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRMSNorm with Llama->Qwen2Moe
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->Qwen2Moe
...
# Modified from transformers_openvla_oft.models.mistral.modeling_mistral.MistralMLP with Mistral->Qwen2Moe
...
# Copied from transformers_openvla_oft.models.qwen2.modeling_qwen2.Qwen2Attention with Qwen2->Qwen2Moe
...
# Copied from transformers_openvla_oft.models.qwen2.modeling_qwen2.Qwen2FlashAttention2 with Qwen2->Qwen2Moe
class Qwen2MoeFlashAttention2(Qwen2MoeAttention):
    ...
    # Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralFlashAttention2._upad_input
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralSdpaAttention with Mistral->Qwen2Moe
...
class Qwen2MoeForCausalLM(Qwen2MoePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, Qwen2MoeForCausalLM
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForSequenceClassification with Llama->Qwen2Moe, LLAMA->QWEN2MOE
