...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTPatchEmbeddings with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfAttention with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfOutput with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTAttention with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTIntermediate with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTOutput with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTLayer with ViT->ViTMSN
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTEncoder with ViT->ViTMSN
...
class ViTMSNModel(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, ViTMSNModel
        >>> import torch
...
class ViTMSNForImageClassification(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, ViTMSNForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
