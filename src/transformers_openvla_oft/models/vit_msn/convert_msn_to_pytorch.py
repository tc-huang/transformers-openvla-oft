...
from transformers_openvla_oft import ViTImageProcessor, ViTMSNConfig, ViTMSNModel
from transformers_openvla_oft.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
