...
FLAX_BERT_FOR_PRETRAINING_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, FlaxBertForPreTraining
...
FLAX_BERT_FOR_NEXT_SENT_PRED_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, FlaxBertForNextSentencePrediction
