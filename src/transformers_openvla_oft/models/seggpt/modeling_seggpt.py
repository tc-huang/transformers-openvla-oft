...
# Copied from transformers_openvla_oft.models.sam.modeling_sam.SamPatchEmbeddings with Sam->SegGpt
...
# Copied from transformers_openvla_oft.models.sam.modeling_sam.SamMLPBlock with SamMLPBlock->SegGptMlp
...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->SegGpt
...
# Copied from transformers_openvla_oft.models.convnext.modeling_convnext.ConvNextLayerNorm with ConvNext->SegGpt
...
class SegGptModel(SegGptPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import SegGptImageProcessor, SegGptModel
