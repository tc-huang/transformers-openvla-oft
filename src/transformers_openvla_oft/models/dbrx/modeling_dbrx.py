...
# Copied from transformers_openvla_oft.models.gemma.modeling_gemma.GemmaRotaryEmbedding with Gemma->Dbrx
...
class DbrxFlashAttention2(DbrxAttention):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        # From: https://github.com/huggingface/transformers/blob/3b8e2932ce743008f63585aae1e1b8b30dc8b3ac/src/transformers_openvla_oft/models/gemma/modeling_gemma.py#L318
...
class DbrxForCausalLM(DbrxPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >> from transformers_openvla_oft import AutoTokenizer, DbrxForCausalLM
