...
from transformers_openvla_oft import AutoImageProcessor, VanConfig, VanForImageClassification
from transformers_openvla_oft.models.deprecated.van.modeling_van import VanLayerScaling
