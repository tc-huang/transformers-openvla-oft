...
# Copied from transformers_openvla_oft.models.convnext.modeling_convnext.drop_path
...
# Copied from transformers_openvla_oft.models.convnext.modeling_convnext.ConvNextDropPath with ConvNext->Van
