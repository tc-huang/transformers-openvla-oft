...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRMSNorm with Llama->OpenLlama
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->OpenLlama
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconLinearScalingRotaryEmbedding with Falcon->OpenLlama
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconDynamicNTKScalingRotaryEmbedding with Falcon->OpenLlama
...
class OpenLlamaAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaAttention._init_rope with Llama->OpenLlama
    def _init_rope(self):
...
class OpenLlamaForCausalLM(OpenLlamaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, OpenLlamaForCausalLM
