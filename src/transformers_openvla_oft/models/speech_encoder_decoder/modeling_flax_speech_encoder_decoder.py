...
class FlaxSpeechEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    as decoder module when created with the :meth*~transformers_openvla_oft.FlaxAutoModel.from_pretrained* class method for the
    ...
    def encode(
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxSpeechEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxSpeechEncoderDecoderModel, AutoTokenizer
