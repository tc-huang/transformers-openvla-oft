...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->StableLm
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconLinearScalingRotaryEmbedding with Falcon->StableLm
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconDynamicNTKScalingRotaryEmbedding with Falcon->StableLm
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralMLP with Mistral->StableLm
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.repeat_kv
...
class StableLmAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.persimmon.modeling_persimmon.PersimmonAttention._init_rope with Persimmon->StableLm
    def _init_rope(self):
...
class StableLmDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # copied from transformers_openvla_oft.models.gpt_neox.modeling_gpt_neox.GPTNeoXLayer.forward
...
# Copied from transformers_openvla_oft.models.persimmon.modeling_persimmon.PersimmonForCausalLM with PERSIMMON->STABLELM,Persimmon->StableLm
class StableLmForCausalLM(StableLmPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]

    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM.__init__ with LLAMA->STABLELM,Llama->StableLm
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, StableLmForCausalLM
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForSequenceClassification with LLAMA->STABLELM,Llama->StableLm
