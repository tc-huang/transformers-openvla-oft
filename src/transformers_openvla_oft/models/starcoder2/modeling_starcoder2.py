...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->Starcoder2
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralFlashAttention2 with Mistral->Starcoder2
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralSdpaAttention with Mistral->Starcoder2
...
class Starcoder2DecoderLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralPreTrainedModel with Mistral->Starcoder2
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralForCausalLM with MISTRAL->STARCODER2,Mistral-7B-v0.1->starcoder2-7b_16k,Mistral->Starcoder2,mistralai->bigcode
class Starcoder2ForCausalLM(Starcoder2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, Starcoder2ForCausalLM
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForSequenceClassification with Llama->Starcoder2, LLAMA->STARCODER2
