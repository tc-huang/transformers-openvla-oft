...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->CPMAnt
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->CPMAnt
...
class CpmAntForCausalLM(CpmAntPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import CPMAntTokenizer, CpmAntForCausalLM
