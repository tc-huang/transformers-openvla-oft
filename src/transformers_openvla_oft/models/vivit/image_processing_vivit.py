...
from transformers_openvla_oft.utils.generic import TensorType
...
class VivitImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_openvla_oft.models.efficientnet.image_processing_efficientnet.EfficientNetImageProcessor.rescale
    def rescale(
        self,
        image: np.ndarray,
