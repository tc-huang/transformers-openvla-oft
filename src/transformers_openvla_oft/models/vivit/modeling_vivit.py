...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfAttention with ViT->Vivit
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTSelfOutput with ViT->Vivit
...
# Copied from transformers_openvla_oft.models.vit.modeling_vit.ViTAttention with ViT->Vivit
...
class VivitModel(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import VivitImageProcessor, VivitModel
...
class VivitForVideoClassification(VivitPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import VivitImageProcessor, VivitForVideoClassification
        >>> from huggingface_hub import hf_hub_download
