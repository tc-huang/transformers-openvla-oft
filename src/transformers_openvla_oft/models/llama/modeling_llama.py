...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, LlamaForCausalLM
...
class LlamaForQuestionAnswering(LlamaPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bloom.modeling_bloom.BloomForQuestionAnswering.__init__ with Bloom->Llama
    def __init__(self, config):
        super().__init__(config)
