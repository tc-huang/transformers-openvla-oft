...
# Copied from transformers_openvla_oft.models.gpt_neo.modeling_flax_gpt_neo.FlaxGPTNeoPreTrainedModel with GPTNeo->Llama, GPT_NEO->LLAMA, transformer->model
...
# Copied from transformers_openvla_oft.models.gptj.modeling_flax_gptj.FlaxGPTJForCausalLM with GPTJ->Llama
