...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    decoder module when created with the :meth*~transformers_openvla_oft.FlaxAutoModel.from_pretrained* class method for the
    encoder and :meth*~transformers_openvla_oft.FlaxAutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def encode(
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxEncoderDecoderModel, BertTokenizer
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import FlaxEncoderDecoderModel
