...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->GroundingDino
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.replace_batch_norm with Detr->GroundingDino
...
class GroundingDinoConvEncoder(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->GroundingDino
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrConvModel with Detr->GroundingDino
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->GroundingDino, Deformable DETR->Grounding DINO
...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->GroundingDino
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrHungarianMatcher with DeformableDetr->GroundingDino
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss with DeformableDetr->GroundingDino
class GroundingDinoLoss(nn.Module):
    ...
    @torch.no_grad()
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss.loss_cardinality
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss.loss_boxes
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss._get_source_permutation_idx
    ...
    # Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLoss._get_target_permutation_idx
...
class GroundingDinoForObjectDetection(GroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, GroundingDinoForObjectDetection
        >>> from PIL import Image
        >>> import requests
