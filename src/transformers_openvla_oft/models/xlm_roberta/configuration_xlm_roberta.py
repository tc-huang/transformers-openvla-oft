...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import XLMRobertaConfig, XLMRobertaModel
...
# Copied from transformers_openvla_oft.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta
