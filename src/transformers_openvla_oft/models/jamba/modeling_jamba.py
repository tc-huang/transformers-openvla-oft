...
# Copied from transformers_openvla_oft.models.mixtral.modeling_mixtral.load_balancing_loss_func with gate->router
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRMSNorm with Llama->Jamba
...
# Adapted from transformers_openvla_oft.models.mistral.modeling_mistral.MistralAttention with Mistral->Jamba
...
# Adapted from transformers_openvla_oft.models.mistral.modeling_mistral.MistralFlashAttention2 with Mistral->Jamba
class JambaFlashAttention2(JambaAttention):
    ...
    # Copied from transformers_openvla_oft.models.mixtral.modeling_mixtral.MixtralFlashAttention2._upad_input
...
# Adapted from transformers_openvla_oft.models.mistral.modeling_mistral.MistralSdpaAttention with Mistral->Jamba
...
# Adapted from transformers_openvla_oft.models.mamba.modeling_mamba.MambaMixer
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralMLP with Mistral->Jamba
...
# Adapted from transformers_openvla_oft.models.mixtral.modeling_mixtral.MixtralSparseMoeBlock with Mistral->Jamba
...
# Adapted from transformers_openvla_oft.models.mistral.modeling_mistral.MistralModel with MISTRAL->JAMBA, Mistral->Jamba
...
# Adapted from transformers_openvla_oft.models.mixtral.modeling_mixtral.MixtralForCausalLM with MIXTRAL->JAMBA, Mixtral->Jamba
class JambaForCausalLM(JambaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, JambaForCausalLM
...
# Copied from transformers_openvla_oft.models.mixtral.modeling_mixtral.MixtralForSequenceClassification with Mixtral->Jamba, MIXTRAL->JAMBA
