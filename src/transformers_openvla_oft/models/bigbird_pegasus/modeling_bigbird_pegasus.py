...
# Copied from transformers_openvla_oft.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_openvla_oft.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with BartConfig->BigBirdPegasusConfig, Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, BigBirdPegasusForConditionalGeneration
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod  # Copied from transformers_openvla_oft.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
class BigBirdPegasusModel(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bart.modeling_bart.BartModel.forward with Bart->BigBirdPegasus
    def forward(
        self,
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
class BigBirdPegasusForSequenceClassification(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
...
class BigBirdPegasusForQuestionAnswering(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
...
# Copied from transformers_openvla_oft.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, BigBirdPegasusForCausalLM
