...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, CTRLModel
        >>> import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_openvla_oft import AutoTokenizer, CTRLLMHeadModel
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_openvla_oft import AutoTokenizer, CTRLForSequenceClassification
