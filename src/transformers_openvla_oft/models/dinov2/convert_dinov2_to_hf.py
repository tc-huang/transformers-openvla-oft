...
from transformers_openvla_oft import BitImageProcessor, Dinov2Config, Dinov2ForImageClassification, Dinov2Model
from transformers_openvla_oft.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, PILImageResampling
