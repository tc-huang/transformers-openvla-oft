...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MVP
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartClassificationHead with Bart->MVP
...
MVP_CONDITIONAL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from transformers_openvla_oft import AutoTokenizer, MvpForConditionalGeneration
...
MVP_SEQUENCE_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from transformers_openvla_oft import AutoTokenizer, MvpForSequenceClassification
...
MVP_QUESTION_ANSWERING_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from transformers_openvla_oft import AutoTokenizer, MvpForQuestionAnswering
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->Mvp
...
class MvpForCausalLM(MvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, MvpForCausalLM
