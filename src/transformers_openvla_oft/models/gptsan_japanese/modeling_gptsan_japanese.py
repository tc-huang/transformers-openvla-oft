...
# Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.router_z_loss_func
...
# Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.load_balancing_loss_func
...
# Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersTop1Router with SwitchTransformers->GPTSanJapanese
...
# Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersSparseMLP with SwitchTransformers->GPTSanJapanese
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->GPTSanJapanese
...
class GPTSanJapanesePreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5PreTrainedModel._shift_right
...
class GPTSanJapaneseForConditionalGeneration(GPTSanJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoModel, AutoTokenizer, trainer_utils
    ...
    # Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersForConditionalGeneration.prepare_decoder_input_ids_from_labels with SwitchTransformers->GPTSanJapanese
    def prepare_decoder_input_ids_from_labels(self, labels: torch.Tensor):
        return self._shift_right(labels)

    # Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartForConditionalGeneration.resize_token_embeddings with MBart->GPTSanJapanese
    def resize_token_embeddings(self, new_num_tokens: int, pad_to_multiple_of: Optional[int] = None) -> nn.Embedding:
        new_embeddings = super().resize_token_embeddings(new_num_tokens, pad_to_multiple_of)
        self._resize_final_logits_bias(new_embeddings.weight.shape[0])
        return new_embeddings

    # Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartForConditionalGeneration._resize_final_logits_bias with MBart->GPTSanJapanese
    ...
    # Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersForConditionalGeneration.set_output_embeddings with SwitchTransformers->GPTSanJapanese
    def set_output_embeddings(self, new_embeddings):
        self.lm_head = new_embeddings

    # Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersForConditionalGeneration.get_output_embeddings with SwitchTransformers->GPTSanJapanese
    def get_output_embeddings(self):
        return self.lm_head

    # Copied from transformers_openvla_oft.models.switch_transformers.modeling_switch_transformers.SwitchTransformersForConditionalGeneration._unpack_router_logits with SwitchTransformers->GPTSanJapanese
