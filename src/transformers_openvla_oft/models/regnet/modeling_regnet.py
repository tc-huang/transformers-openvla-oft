...
# Copied from transformers_openvla_oft.models.resnet.modeling_resnet.ResNetShortCut with ResNet->RegNet
...
class RegNetPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.resnet.modeling_resnet.ResNetPreTrainedModel._init_weights
...
# Copied from transformers_openvla_oft.models.resnet.modeling_resnet.ResNetModel with RESNET->REGNET,ResNet->RegNet
...
# Copied from transformers_openvla_oft.models.resnet.modeling_resnet.ResNetForImageClassification with RESNET->REGNET,ResNet->RegNet,resnet->regnet
