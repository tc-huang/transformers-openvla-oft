...
# Copied from transformers_openvla_oft.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from transformers_openvla_oft.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
