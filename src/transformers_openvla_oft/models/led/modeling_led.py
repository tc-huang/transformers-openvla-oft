...
# Copied from transformers_openvla_oft.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from transformers_openvla_oft.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from transformers_openvla_oft import AutoTokenizer, LEDForConditionalGeneration
...
class LEDModel(LEDPreTrainedModel):
    ...
    def forward(
        ...
        # https://github.com/huggingface/transformers/blob/ac3cb660cad283163f7c73cad511124e845ca388/src/transformers_openvla_oft/models/bart/modeling_bart.py#L1153
...
class LEDForSequenceClassification(LEDPreTrainedModel):
    ...
    def __init__(self, config: LEDConfig, **kwargs):
        warnings.warn(
            "The `transformers_openvla_oft.LEDForSequenceClassification` class is deprecated and will be removed in version 5 of"
