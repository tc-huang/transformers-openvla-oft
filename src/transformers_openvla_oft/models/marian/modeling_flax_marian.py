...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartEncoderLayer with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartDecoderLayer with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->Marian
...
class FlaxMarianPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, FlaxMarianMTModel
