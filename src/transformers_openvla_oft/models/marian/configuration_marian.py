...
class MarianConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import MarianModel, MarianConfig
...
class MarianOnnxConfig(OnnxSeq2SeqConfigWithPast):
    @property
    # Copied from transformers_openvla_oft.models.bart.configuration_bart.BartOnnxConfig.inputs
