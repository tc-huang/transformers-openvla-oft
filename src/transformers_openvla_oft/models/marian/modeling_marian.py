...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartEncoderLayer with Bart->Marian, BART->MARIAN
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderLayer with Bart->Marian, BART->MARIAN
...
MARIAN_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, MarianMTModel
...
class MarianModel(MarianPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, MarianModel
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->Marian
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM with Bart->Marian, facebook/bart-base->Helsinki-NLP/opus-mt-fr-en
class MarianForCausalLM(MarianPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, MarianForCausalLM
