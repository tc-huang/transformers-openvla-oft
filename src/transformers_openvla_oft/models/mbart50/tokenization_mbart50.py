...
class MBart50Tokenizer(PreTrainedTokenizer):
    ...
    ```python
    >>> from transformers_openvla_oft import MBart50Tokenizer
    ...
    # Copied from transformers_openvla_oft.models.albert.tokenization_albert.AlbertTokenizer.convert_tokens_to_string
