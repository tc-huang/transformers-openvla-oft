...
# PYTHONPATH=/tmp/Megatron-LM python src/transformers_openvla_oft/models/megatron_bert/convert_megatron_bert_checkpoint.py ...
#
...
from transformers_openvla_oft import MegatronBertConfig
