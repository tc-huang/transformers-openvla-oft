...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import BlipConfig, BlipModel
