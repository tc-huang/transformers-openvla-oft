...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->blip
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->Blip
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->Blip
...
class BlipModel(BlipPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, BlipModel
...
class BlipForConditionalGeneration(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, BlipForConditionalGeneration
...
class BlipForQuestionAnswering(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, BlipForQuestionAnswering
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, BlipForImageTextRetrieval
