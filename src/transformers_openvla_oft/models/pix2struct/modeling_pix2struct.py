...
# Adapted from transformers_openvla_oft.models.t5.modeling_t5.T5LayerNorm with T5->Pix2Struct
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseGatedActDense with T5DenseGatedActDense->Pix2StructVisionMlp,T5Config->Pix2StructVisionConfig,config.d_model->config.hidden_size,dropout_rate->dropout_rate
...
class Pix2StructPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5PreTrainedModel._shift_right with T5->Pix2Struct
...
class Pix2StructVisionModel(Pix2StructPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoProcessor, Pix2StructVisionModel
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseGatedActDense with T5->Pix2StructText,d_model->hidden_size
...
class Pix2StructTextLayerFF(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerFF.forward
    def forward(self, hidden_states):
...
class Pix2StructTextAttention(nn.Module):
    ...
    @staticmethod
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Attention._relative_position_bucket
    ...
    # Adapted from transformers_openvla_oft.models.t5.modeling_t5.T5Attention.compute_bias
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerSelfAttention with T5LayerNorm->Pix2StructLayerNorm,T5Attention->Pix2StructTextAttention,self.SelfAttention->self.attention,config.d_model->config.hidden_size
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerCrossAttention with T5LayerNorm->Pix2StructLayerNorm,T5Attention->Pix2StructTextAttention,self.EncDecAttention->self.attention,config.d_model->config.hidden_size
...
class Pix2StructTextModel(Pix2StructPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5PreTrainedModel._reorder_cache
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, Pix2StructTextModel
