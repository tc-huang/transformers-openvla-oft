...
class GPTNeoXFlashAttention2(GPTNeoXAttention):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaFlashAttention2._upad_input with num_heads->num_attention_heads
...
class GPTNeoXRotaryEmbedding(nn.Module):
    # Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding.__init__
...
# copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaLinearScalingRotaryEmbedding.__init__
...
class GPTNeoXDynamicNTKScalingRotaryEmbedding(GPTNeoXRotaryEmbedding):
    ...
    # copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaDynamicNTKScalingRotaryEmbedding.__init__
...
class GPTNeoXForCausalLM(GPTNeoXPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, GPTNeoXForCausalLM, GPTNeoXConfig
        >>> import torch
