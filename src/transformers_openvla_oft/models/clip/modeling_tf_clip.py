...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, TFCLIPModel
