...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->PegasusX
...
PEGASUS_X_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, PegasusXForConditionalGeneration
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->PegasusX
