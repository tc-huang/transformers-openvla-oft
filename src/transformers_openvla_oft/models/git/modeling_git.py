...
@dataclass
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->Git
...
class GitAttention(nn.Module):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertAttention.__init__ with Bert->Git
    def __init__(self, config, position_embedding_type=None):
        super().__init__()
...
class GitEncoder(nn.Module):
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertEncoder.__init__ with Bert->Git
    def __init__(self, config):
        super().__init__()
        self.config = config
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Git
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->GitVision
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->GitVision, CLIPConfig
...
class GitVisionTransformer(nn.Module):
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer.__init__ with CLIPEncoder->GitVisionEncoder, CLIP->Git
    def __init__(self, config: GitVisionConfig):
        super().__init__()
        self.config = config
...
class GitVisionModel(GitPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP->Git
    def __init__(self, config: GitVisionConfig):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, GitVisionModel
...
class GitForCausalLM(GitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, AutoModelForCausalLM
        >>> import requests
        >>> from PIL import Image
