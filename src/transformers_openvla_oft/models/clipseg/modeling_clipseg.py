...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->clipseg
...
@dataclass
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPOutput with CLIP->CLIPSeg
...
class CLIPSegVisionEmbeddings(nn.Module):
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings.__init__ with CLIP->CLIPSeg
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->CLIPSeg
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention with CLIP->CLIPSeg
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->CLIPSeg
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->CLIPSeg
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->CLIPSeg
...
class CLIPSegTextTransformer(nn.Module):
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextTransformer.__init__ with CLIP->CLIPSeg
    def __init__(self, config: CLIPSegTextConfig):
        super().__init__()
        self.config = config
        embed_dim = config.hidden_size
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextTransformer.forward with clip->clipseg, CLIP->CLIPSeg
    def forward(
        self,
...
class CLIPSegTextModel(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, CLIPSegTextModel
...
class CLIPSegVisionTransformer(nn.Module):
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer.__init__ with CLIP->CLIPSeg
    def __init__(self, config: CLIPSegVisionConfig):
        super().__init__()
        self.config = config
        embed_dim = config.hidden_size
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer.forward
    def forward(
        self,
...
class CLIPSegVisionModel(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, CLIPSegVisionModel
...
class CLIPSegModel(CLIPSegPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, CLIPSegModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, CLIPSegModel
...
class CLIPSegDecoderLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer.__init__ with CLIP->CLIPSeg
    def __init__(self, config: CLIPSegConfig):
        super().__init__()
        self.embed_dim = config.hidden_size
        self.self_attn = CLIPSegAttention(config)
...
class CLIPSegForImageSegmentation(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, CLIPSegForImageSegmentation
        >>> from PIL import Image
        >>> import requests
