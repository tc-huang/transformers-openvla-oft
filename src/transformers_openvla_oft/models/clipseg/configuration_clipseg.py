...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import CLIPSegConfig, CLIPSegModel
