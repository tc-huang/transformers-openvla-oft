...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.MultiScaleDeformableAttentionFunction
...
@dataclass
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrDecoderOutput with DeformableDetr->Deta
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->Deta
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.replace_batch_norm with Detr->Deta
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrSinePositionEmbedding with DeformableDetr->Deta
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrLearnedPositionEmbedding
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.build_position_encoding with Detr->Deta
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.multi_scale_deformable_attention
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->Deta
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiheadAttention with DeformableDetr->Deta,Deformable DETR->DETA
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrClassificationHead
...
class DetaModel(DetaPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrModel.get_encoder
    def get_encoder(self):
        return self.encoder

    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrModel.get_decoder
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrModel.get_valid_ratio
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrModel.get_proposal_pos_embed
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, DetaModel
...
class DetaForObjectDetection(DetaPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrForObjectDetection.__init__ with DeformableDetr->Deta
    def __init__(self, config: DetaConfig):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, DetaForObjectDetection
        >>> from PIL import Image
        >>> import requests
...
class DetaLoss(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrLoss.get_loss
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrMLPPredictionHead
...
# Copied from transformers_openvla_oft.models.deformable_detr.modeling_deformable_detr.DeformableDetrHungarianMatcher with DeformableDetr->Deta
