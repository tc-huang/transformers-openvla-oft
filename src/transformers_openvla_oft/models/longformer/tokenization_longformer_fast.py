...
# Copied from transformers_openvla_oft.models.roberta.tokenization_roberta_fast.RobertaTokenizerFast with FacebookAI/roberta-base->allenai/longformer-base-4096, RoBERTa->Longformer all-casing, Roberta->Longformer
class LongformerTokenizerFast(PreTrainedTokenizerFast):
    ...
    ```python
    >>> from transformers_openvla_oft import LongformerTokenizerFast
