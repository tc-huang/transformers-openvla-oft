...
# Copied from transformers_openvla_oft.models.roberta.tokenization_roberta.RobertaTokenizer with FacebookAI/roberta-base->allenai/longformer-base-4096, RoBERTa->Longformer all-casing, RobertaTokenizer->LongformerTokenizer
class LongformerTokenizer(PreTrainedTokenizer):
    ...
    ```python
    >>> from transformers_openvla_oft import LongformerTokenizer
