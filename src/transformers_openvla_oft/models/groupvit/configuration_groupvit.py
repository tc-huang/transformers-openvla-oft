...
class GroupViTTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import GroupViTTextConfig, GroupViTTextModel
...
class GroupViTVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import GroupViTVisionConfig, GroupViTVisionModel
