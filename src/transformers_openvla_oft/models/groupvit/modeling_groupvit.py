...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.clip_loss with clip->groupvit
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->GroupViT
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->GroupViT
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPTextTransformer with CLIPText->GroupViTText, CLIPEncoder->GroupViTTextEncoder, CLIP_TEXT->GROUPVIT_TEXT
...
class GroupViTTextModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import CLIPTokenizer, GroupViTTextModel
...
class GroupViTVisionModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, GroupViTVisionModel
...
class GroupViTModel(GroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import CLIPTokenizer, GroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, GroupViTModel
