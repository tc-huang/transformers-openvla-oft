...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->Swin
...
class SwinForMaskedImageModeling(SwinPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, SwinForMaskedImageModeling
        >>> import torch
