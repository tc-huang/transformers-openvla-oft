...
class SqueezeBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import SqueezeBertConfig, SqueezeBertModel
...
# # Copied from transformers_openvla_oft.models.bert.configuration_bert.BertOnxxConfig with Bert->SqueezeBert
