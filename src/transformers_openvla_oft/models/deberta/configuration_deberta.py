...
class DebertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import DebertaConfig, DebertaModel
...
# Copied from transformers_openvla_oft.models.deberta_v2.configuration_deberta_v2.DebertaV2OnnxConfig
