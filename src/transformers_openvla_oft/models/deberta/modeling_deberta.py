...
class XSoftmax(torch.autograd.Function):
    ...
    ```python
    >>> import torch
    >>> from transformers_openvla_oft.models.deberta.modeling_deberta import XSoftmax
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->Deberta
