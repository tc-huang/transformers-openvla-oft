...
from transformers_openvla_oft import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from transformers_openvla_oft.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
