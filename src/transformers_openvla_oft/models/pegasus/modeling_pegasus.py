...
# Copied from transformers_openvla_oft.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Pegasus
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Pegasus, MBART->PEGASUS
...
# Copied from transformers_openvla_oft.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Pegasus, MBART->PEGASUS
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PegasusModel
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->Pegasus
...
class PegasusForCausalLM(PegasusPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM.forward with Bart->Pegasus, facebook/bart-base->google/pegasus-large
    def forward(
        self,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PegasusForCausalLM
