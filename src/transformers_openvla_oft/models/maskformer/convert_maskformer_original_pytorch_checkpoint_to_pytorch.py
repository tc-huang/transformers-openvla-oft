...
from transformers_openvla_oft.models.maskformer.feature_extraction_maskformer import MaskFormerImageProcessor
from transformers_openvla_oft.models.maskformer.modeling_maskformer import (
    MaskFormerConfig,
