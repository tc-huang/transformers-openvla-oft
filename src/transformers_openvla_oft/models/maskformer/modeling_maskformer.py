...
@dataclass
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from transformers_openvla_oft.models.detr.modeling_detr.DetrDecoderLayer
...
class MaskFormerModel(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, MaskFormerModel
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, MaskFormerForInstanceSegmentation
        >>> from PIL import Image
        >>> import requests
