...
# Copied from transformers_openvla_oft.models.beit.modeling_beit.BeitDropPath with Beit->FocalNet
...
# Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinPreTrainedModel with Swin->FocalNet,swin->focalnet
...
class FocalNetForMaskedImageModeling(FocalNetPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, FocalNetConfig, FocalNetForMaskedImageModeling
        >>> import torch
...
class FocalNetForImageClassification(FocalNetPreTrainedModel):
    # Copied from transformers_openvla_oft.models.swin.modeling_swin.SwinForImageClassification.__init__ with Swin->FocalNet, swin->focalnet
    def __init__(self, config):
        super().__init__(config)
