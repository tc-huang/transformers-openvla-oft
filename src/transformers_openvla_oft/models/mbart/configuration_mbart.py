...
class MBartConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import MBartConfig, MBartModel
...
# Copied from transformers_openvla_oft.models.bart.configuration_bart.BartOnnxConfig with Bart->MBart
