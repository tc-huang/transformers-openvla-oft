...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartFlashAttention2 with Bart->MBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_openvla_oft import AutoTokenizer, MBartForConditionalGeneration
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartForCausalLM with Bart->MBart, facebook/bart-base->facebook/mbart-large-cc25
class MBartForCausalLM(MBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, MBartForCausalLM
