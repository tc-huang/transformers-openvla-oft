...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltSelfAttention with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltSelfOutput with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltAttention with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltIntermediate with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltOutput with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltLayer with Vilt->Tvlt
...
# Copied from transformers_openvla_oft.models.vilt.modeling_vilt.ViltEncoder with Vilt->Tvlt
...
class TvltModel(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import TvltProcessor, TvltModel
        >>> import numpy as np
        >>> import torch
...
class TvltForPreTraining(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import TvltProcessor, TvltForPreTraining
        >>> import numpy as np
        >>> import torch
...
class TvltForAudioVisualClassification(TvltPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_openvla_oft import TvltProcessor, TvltForAudioVisualClassification
        >>> import numpy as np
        >>> import torch
