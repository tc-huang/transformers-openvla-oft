...
FLAX_VISION_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoImageProcessor, FlaxViTModel
...
FLAX_VISION_CLASSIF_DOCSTRING = """
    ...
    ```python
    >>> from transformers_openvla_oft import AutoImageProcessor, FlaxViTForImageClassification
    >>> from PIL import Image
    >>> import jax
    >>> import requests
