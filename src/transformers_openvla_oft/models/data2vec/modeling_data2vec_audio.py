...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2SamePadLayer with Wav2Vec2->Data2VecAudio
...
class Data2VecAudioFeatureEncoder(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureEncoder._freeze_parameters
    def _freeze_parameters(self):
        for param in self.parameters():
            param.requires_grad = False
        self._requires_grad = False

    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureEncoder.forward
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureProjection with Wav2Vec2->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeedForward with Wav2Vec2->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2EncoderLayer with Wav2Vec2->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Encoder with Wav2Vec2->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Adapter with Wav2Vec2->Data2VecAudio
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2AdapterLayer with Wav2Vec2->Data2VecAudio
...
class Data2VecAudioPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2PreTrainedModel._get_feat_extract_output_lengths with
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2PreTrainedModel._get_feature_vector_attention_mask
...
class Data2VecAudioForCTC(Data2VecAudioPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForCTC.forward with wav2vec2->data2vec_audio
    def forward(
        self,
        input_values: Optional[torch.Tensor],
        attention_mask: Optional[torch.Tensor] = None,
...
class Data2VecAudioForSequenceClassification(Data2VecAudioPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForSequenceClassification.forward with wav2vec2->data2vec_audio
    def forward(
        self,
        input_values: Optional[torch.Tensor],
        attention_mask: Optional[torch.Tensor] = None,
...
class Data2VecAudioForAudioFrameClassification(Data2VecAudioPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForAudioFrameClassification.forward with wav2vec2->data2vec_audio
    def forward(
        self,
        input_values: Optional[torch.Tensor],
        attention_mask: Optional[torch.Tensor] = None,
...
class Data2VecAudioForXVector(Data2VecAudioPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForXVector.forward with wav2vec2->data2vec_audio
    def forward(
        self,
        input_values: Optional[torch.Tensor],
        attention_mask: Optional[torch.Tensor] = None,
