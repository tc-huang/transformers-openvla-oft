...
# Copied from transformers_openvla_oft.models.vit.modeling_tf_vit.TFViTIntermediate with ViT->Data2VecVision
...
class TFData2VecVisionForSemanticSegmentation(TFData2VecVisionPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, TFData2VecVisionForSemanticSegmentation
