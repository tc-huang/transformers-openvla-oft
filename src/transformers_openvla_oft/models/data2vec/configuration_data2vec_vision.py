...
class Data2VecVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import Data2VecVisionConfig, Data2VecVisionModel
...
# Copied from transformers_openvla_oft.models.vit.configuration_vit.ViTOnnxConfig
