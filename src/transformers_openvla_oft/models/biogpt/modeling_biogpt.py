...
# Copied from transformers_openvla_oft.models.opt.modeling_opt.OPTLearnedPositionalEmbedding with OPT->BioGpt
...
# Copied from transformers_openvla_oft.models.bart.modeling_bart.BartAttention with Bart->BioGpt
