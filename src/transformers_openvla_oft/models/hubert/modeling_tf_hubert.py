...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2._sample_without_replacement
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2._scatter_values_on_batch_indices
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2._compute_mask_indices
...
# Copied from transformers_openvla_oft.models.bart.modeling_tf_bart._expand_mask
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2GroupNorm with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2WeightNormConv1D with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2NoLayerNormConvLayer with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2LayerNormConvLayer with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2GroupNormConvLayer with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2PositionalConvEmbedding with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2SamePadLayer with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.bart.modeling_tf_bart.TFBartAttention with TFBart->TFHubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2FeedForward with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderLayer with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderLayerStableLayerNorm with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2Encoder with Wav2Vec2->Hubert
...
# Copied from transformers_openvla_oft.models.wav2vec2.modeling_tf_wav2vec2.TFWav2Vec2EncoderStableLayerNorm with Wav2Vec2->Hubert
...
class TFHubertModel(TFHubertPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, TFHubertModel
...
class TFHubertForCTC(TFHubertPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_openvla_oft import AutoProcessor, TFHubertForCTC
        >>> from datasets import load_dataset
        >>> import soundfile as sf
