...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import MobileBertConfig, MobileBertModel
...
# Copied from transformers_openvla_oft.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert
