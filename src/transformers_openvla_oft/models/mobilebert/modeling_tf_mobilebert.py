...
# Copied from transformers_openvla_oft.models.bert.modeling_tf_bert.TFBertPreTrainingLoss
...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel, TFMobileBertPreTrainingLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_openvla_oft import AutoTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_openvla_oft import AutoTokenizer, TFMobileBertForNextSentencePrediction
