...
class TFDPRContextEncoder(TFDPRPretrainedContextEncoder):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import TFDPRContextEncoder, DPRContextEncoderTokenizer
...
class TFDPRQuestionEncoder(TFDPRPretrainedQuestionEncoder):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class TFDPRReader(TFDPRPretrainedReader):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import TFDPRReader, DPRReaderTokenizer
