...
class ImageGPTModel(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, ImageGPTModel
...
class ImageGPTForCausalImageModeling(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, ImageGPTForCausalImageModeling
        >>> import torch
...
class ImageGPTForImageClassification(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, ImageGPTForImageClassification
        >>> from PIL import Image
        >>> import requests
