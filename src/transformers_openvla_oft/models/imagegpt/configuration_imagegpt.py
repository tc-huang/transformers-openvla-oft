...
class ImageGPTConfig(PretrainedConfig):
    ...
    Args:
        ...
        activation_function (`str`, *optional*, defaults to `"quick_gelu"`):
            Activation function (can be one of the activation functions defined in src/transformers_openvla_oft/activations.py).
    ...
    ```python
    >>> from transformers_openvla_oft import ImageGPTConfig, ImageGPTModel
