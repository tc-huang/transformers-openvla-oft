...
from transformers_openvla_oft.modeling_utils import dtype_byte_size
from transformers_openvla_oft.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from transformers_openvla_oft.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from transformers_openvla_oft.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from transformers_openvla_oft import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer
