...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerNorm with T5->SwitchTransformers
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseActDense with T5->SwitchTransformers
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Attention with T5->SwitchTransformers
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerSelfAttention with T5->SwitchTransformers
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerCrossAttention with T5->SwitchTransformers
...
class SwitchTransformersModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, SwitchTransformersModel
...
class SwitchTransformersForConditionalGeneration(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, SwitchTransformersForConditionalGeneration
...
class SwitchTransformersEncoderModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, SwitchTransformersEncoderModel
