...
class XmodConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import XmodConfig, XmodModel
...
# Copied from transformers_openvla_oft.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->Xmod
