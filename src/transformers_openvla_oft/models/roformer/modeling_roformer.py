...
# Copied from transformers_openvla_oft.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->RoFormer
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfOutput with Bert->RoFormer
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertIntermediate with Bert->RoFormer
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOutput with Bert->RoFormer
...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoFormer
...
class RoFormerForCausalLM(RoFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, RoFormerForCausalLM, RoFormerConfig
        >>> import torch
