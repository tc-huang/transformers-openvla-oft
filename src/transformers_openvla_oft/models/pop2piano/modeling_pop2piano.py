...
from transformers_openvla_oft.generation import GenerationConfig
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerNorm with T5->Pop2Piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseActDense with T5->Pop2Piano,t5->pop2piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5DenseGatedActDense with T5->Pop2Piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerFF with T5->Pop2Piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Attention with T5->Pop2Piano,t5->pop2piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerSelfAttention with T5->Pop2Piano,t5->pop2piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5LayerCrossAttention with T5->Pop2Piano,t5->pop2piano
...
# Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Block with T5->Pop2Piano,t5->pop2piano
...
class Pop2PianoStack(Pop2PianoPreTrainedModel):
    # Copied from transformers_openvla_oft.models.t5.modeling_t5.T5Stack.__init__ with T5->Pop2Piano,t5->pop2piano
