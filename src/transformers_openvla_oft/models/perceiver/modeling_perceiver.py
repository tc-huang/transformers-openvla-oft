...
PERCEIVER_MODEL_START_DOCSTRING = r"""
    ...
    Parameters:
        ...
        decoder (*DecoderType*, *optional*):
            ...
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverBasicDecoder*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverClassificationDecoder*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverMultimodalDecoder*.
        input_preprocessor (*PreprocessorType*, *optional*):
            Optional input preprocessor to use. Examples include
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverImagePreprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverAudioPreprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverTextPreprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverMultimodalPreprocessor*.
        output_postprocessor (*PostprocessorType*, *optional*):
            Optional output postprocessor to use. Examples include
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverImagePostprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverAudioPostprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverClassificationPostprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverProjectionPostprocessor*,
            *transformers_openvla_oft.models.perceiver.modeling_perceiver.PerceiverMultimodalPostprocessor*.
...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import PerceiverConfig, PerceiverTokenizer, PerceiverImageProcessor, PerceiverModel
        >>> from transformers_openvla_oft.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoImageProcessor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np
