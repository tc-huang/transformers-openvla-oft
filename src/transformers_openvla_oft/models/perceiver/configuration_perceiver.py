...
class PerceiverConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import PerceiverModel, PerceiverConfig
...
class PerceiverOnnxConfig(OnnxConfig):
    ...
    def generate_dummy_inputs(
        ...
        # copied from `transformers_openvla_oft.onnx.config.OnnxConfig` and slightly altered/simplified
