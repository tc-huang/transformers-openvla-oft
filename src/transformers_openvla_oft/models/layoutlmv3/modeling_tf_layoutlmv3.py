...
class TFLayoutLMv3MainLayer(keras.layers.Layer):
    ...
    def get_extended_attention_mask(self, attention_mask: tf.Tensor) -> tf.Tensor:
        # Adapted from transformers_openvla_oft.modelling_utils.ModuleUtilsMixin.get_extended_attention_mask
...
class TFLayoutLMv3Model(TFLayoutLMv3PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, TFAutoModel
...
class TFLayoutLMv3ForSequenceClassification(TFLayoutLMv3PreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, TFAutoModelForSequenceClassification
        >>> from datasets import load_dataset
        >>> import tensorflow as tf
...
class TFLayoutLMv3ForTokenClassification(TFLayoutLMv3PreTrainedModel, TFTokenClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, TFAutoModelForTokenClassification
        >>> from datasets import load_dataset
...
class TFLayoutLMv3ForQuestionAnswering(TFLayoutLMv3PreTrainedModel, TFQuestionAnsweringLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, TFAutoModelForQuestionAnswering
        >>> from datasets import load_dataset
        >>> import tensorflow as tf
