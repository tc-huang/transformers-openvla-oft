...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AltCLIPConfig, AltCLIPModel
