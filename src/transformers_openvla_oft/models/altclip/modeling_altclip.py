...
@dataclass
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPOutput with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaSelfOutput
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaAttention with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaIntermediate with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaOutput
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaLayer with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.roberta.modeling_roberta.RobertaEncoder with Roberta->AltRoberta
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPMLP with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPEncoder with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->AltCLIP
...
# Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPVisionTransformer with CLIPVisionTransformer->AltCLIPVisionTransformer,CLIPVisionConfig->AltCLIPVisionConfig,CLIPVisionEmbeddings->AltCLIPVisionEmbeddings,CLIPEncoder->AltCLIPEncoder,CLIP_VISION_INPUTS_DOCSTRING->ALTCLIP_VISION_INPUTS_DOCSTRING
...
class AltCLIPVisionModel(AltCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_openvla_oft import AutoProcessor, AltCLIPVisionModel
...
class AltRobertaModel(AltCLIPPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.__init__ with Bert->AltRoberta
...
class AltCLIPTextModel(AltCLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, AltCLIPTextModel
...
class AltCLIPModel(AltCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoProcessor, AltCLIPModel
