...
class PersimmonConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import PersimmonModel, PersimmonConfig
    ...
    # Copied from transformers_openvla_oft.models.llama.configuration_llama.LlamaConfig._rope_scaling_validation
