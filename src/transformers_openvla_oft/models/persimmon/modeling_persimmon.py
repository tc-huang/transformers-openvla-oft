...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->Persimmon
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconLinearScalingRotaryEmbedding with Falcon->Persimmon
...
# Copied from transformers_openvla_oft.models.falcon.modeling_falcon.FalconDynamicNTKScalingRotaryEmbedding with Falcon->Persimmon
...
# Copied from transformers_openvla_oft.models.gpt_neox.modeling_gpt_neox.GPTNeoXMLP with GPTNeoX->Persimmon
...
class PersimmonAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.bloom.modeling_bloom.BloomAttention._split_heads
...
class PersimmonForCausalLM(PersimmonPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForCausalLM.__init__ with LLAMA->PERSIMMON,Llama->Persimmon
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, PersimmonForCausalLM
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaForSequenceClassification with LLAMA->PERSIMMON,Llama->Persimmon
