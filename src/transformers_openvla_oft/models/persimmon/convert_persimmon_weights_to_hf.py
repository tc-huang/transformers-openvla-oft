...
from transformers_openvla_oft import LlamaTokenizer, PersimmonConfig, PersimmonForCausalLM
...
python src/transformers_openvla_oft/models/persimmon/convert_persimmon_weights_to_hf.py  --input_dir /path/to/downloaded/persimmon/weights/ --output_dir /output/path
```

Thereafter, models can be loaded via:

```py
from transformers_openvla_oft import PersimmonForCausalLM, PersimmonTokenizer
