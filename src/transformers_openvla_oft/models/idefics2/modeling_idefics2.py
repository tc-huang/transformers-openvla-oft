...
@dataclass
# Copied from transformers_openvla_oft.models.idefics.modeling_idefics.IdeficsCausalLMOutputWithPast with Idefics->Idefics2
...
# Copied from transformers_openvla_oft.models.siglip.modeling_siglip.SiglipAttention with Siglip->Idefics2Vision
class Idefics2VisionAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    # Copied from transformers_openvla_oft.models.clip.modeling_clip.CLIPAttention.__init__
...
# Copied from transformers_openvla_oft.models.siglip.modeling_siglip.SiglipMLP with Siglip->Idefics2Vision
...
# Copied from transformers_openvla_oft.models.siglip.modeling_siglip.SiglipMultiheadAttentionPoolingHead with Siglip->Idefics2
...
class Idefics2EncoderLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.siglip.modeling_siglip.SiglipEncoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: torch.Tensor,
...
# Copied from transformers_openvla_oft.models.siglip.modeling_siglip.SiglipEncoder with Siglip->Idefics2
...
# Copied from transformers_openvla_oft.models.llama.modeling_llama.LlamaRMSNorm with Llama->Idefics2
...
# Copied from transformers_openvla_oft.models.mistral.modeling_mistral.MistralFlashAttention2 with MistralAttention->Idefics2PerceiverAttention,MistralFlashAttention->Idefics2PerceiverFlashAttention,Mistral->Idefics2
...
class Idefics2ForConditionalGeneration(Idefics2PreTrainedModel):
    ...
    def tie_weights(self):
        """
        Overwrite `transformers_openvla_oft.modeling_utils.PreTrainedModel.tie_weights` to handle the case of DecoupledLinear and DecoupledEmbedding.
        """
    ...
    def forward(
        ...
        >>> from transformers_openvla_oft import AutoProcessor, AutoModelForVision2Seq
