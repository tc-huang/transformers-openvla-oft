...
from transformers_openvla_oft import AutoTokenizer, MambaConfig, MambaForCausalLM
from transformers_openvla_oft.utils import logging
from transformers_openvla_oft.utils.import_utils import is_mamba_ssm_available
...
if is_mamba_ssm_available():
    ...
    def convert_ssm_config_to_hf_config(config_ssm: MambaConfigSSM) -> MambaConfig:
        """Convert a MambaConfig from mamba_ssm to a MambaConfig from transformers_openvla_oft."""
