...
class DepthAnythingReassembleLayer(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.dpt.modeling_dpt.DPTReassembleLayer.forward
...
class DepthAnythingFeatureFusionStage(nn.Module):
    # Copied from transformers_openvla_oft.models.dpt.modeling_dpt.DPTFeatureFusionStage.__init__ with DPT->DepthAnything
    def __init__(self, config):
        super().__init__()
        self.layers = nn.ModuleList()
...
# Copied from transformers_openvla_oft.models.dpt.modeling_dpt.DPTPreTrainedModel with DPT->DepthAnything,dpt->depth_anything
