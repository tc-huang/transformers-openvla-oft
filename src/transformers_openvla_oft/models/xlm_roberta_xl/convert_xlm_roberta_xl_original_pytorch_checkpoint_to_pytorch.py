...
from transformers_openvla_oft import XLMRobertaConfig, XLMRobertaXLForMaskedLM, XLMRobertaXLForSequenceClassification
...
from transformers_openvla_oft.models.roberta.modeling_roberta import RobertaAttention
