...
# Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
class XLMRobertaXLModel(XLMRobertaXLPreTrainedModel):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertModel.__init__ with Bert->XLMRobertaXL
...
class XLMRobertaXLForCausalLM(XLMRobertaXLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, RobertaForCausalLM, RobertaConfig
        >>> import torch
