...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import XLMRobertaXLConfig, XLMRobertaXLModel
...
# Copied from transformers_openvla_oft.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL
