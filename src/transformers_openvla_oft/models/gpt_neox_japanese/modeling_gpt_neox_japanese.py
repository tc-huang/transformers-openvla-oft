...
# Copied from transformers_openvla_oft.models.gpt_neox.modeling_gpt_neox.GPTNeoXRotaryEmbedding with GPTNeoXRotaryEmbedding->RotaryEmbedding
...
class GPTNeoXJapaneseModel(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, GPTNeoXJapaneseModel
        >>> import torch
...
class GPTNeoXJapaneseForCausalLM(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, GPTNeoXJapaneseForCausalLM, GPTNeoXJapaneseConfig
        >>> import torch
