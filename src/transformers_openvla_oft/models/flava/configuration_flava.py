...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FlavaImageCodebookConfig, FlavaImageCodebook
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import FlavaConfig, FlavaModel, FlavaForPreTraining
