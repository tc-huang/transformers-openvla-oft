...
from transformers_openvla_oft import FlavaConfig, FlavaForPreTraining
from transformers_openvla_oft.models.flava.convert_dalle_to_flava_codebook import convert_dalle_checkpoint
