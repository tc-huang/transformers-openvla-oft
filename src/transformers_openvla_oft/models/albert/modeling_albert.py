...
class AlbertAttention(nn.Module):
    ...
    # Copied from transformers_openvla_oft.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_openvla_oft import AutoTokenizer, AlbertForPreTraining
        >>> import torch
...
class AlbertForMaskedLM(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_openvla_oft import AutoTokenizer, AlbertForMaskedLM
