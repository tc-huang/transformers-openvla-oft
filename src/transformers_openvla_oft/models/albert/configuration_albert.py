...
class AlbertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_openvla_oft import AlbertConfig, AlbertModel
...
# Copied from transformers_openvla_oft.models.bert.configuration_bert.BertOnnxConfig with Roberta->Albert
