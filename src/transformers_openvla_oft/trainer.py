...
class Trainer:
    ...
    def add_callback(self, callback):
        """
        Add a callback to the current list of [`~transformers_openvla_oft.TrainerCallback`].

        Args:
           callback (`type` or [`~transformers_openvla_oft.TrainerCallback`]):
               A [`~transformers_openvla_oft.TrainerCallback`] class or an instance of a [`~transformers_openvla_oft.TrainerCallback`]. In the
    ...
    def pop_callback(self, callback):
        """
        Remove a callback from the current list of [`~transformers_openvla_oft.TrainerCallback`] and returns it.
        ...
        Returns:
            [`~transformers_openvla_oft.TrainerCallback`]: The callback removed, if found.
        """
        return self.callback_handler.pop_callback(callback)

    def remove_callback(self, callback):
        """
        Remove a callback from the current list of [`~transformers_openvla_oft.TrainerCallback`].
    ...
    def get_optimizer_cls_and_kwargs(
        ...
        Args:
            args (`transformers_openvla_oft.training_args.TrainingArguments`):
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", Dict[str, Any]]):
        ...
        if self.is_deepspeed_enabled:
            ...
            from transformers_openvla_oft.integrations.deepspeed import HfTrainerDeepSpeedConfig
