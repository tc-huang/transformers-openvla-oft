...
class PretrainedConfig(PushToHubMixin):
    ...
    - **model_type** (`str`) -- An identifier for the model type, serialized into the JSON file, and used to recreate
      the correct object in [`~transformers_openvla_oft.AutoConfig`].
    - **is_composition** (`bool`) -- Whether the config class is composed of multiple sub-configs. In this case the
      config has to be initialized from two or more configs of type [`~transformers_openvla_oft.PretrainedConfig`] like:
      [`~transformers_openvla_oft.EncoderDecoderConfig`] or [`~RagConfig`].
    ...
    Arg:
        ...
        return_dict (`bool`, *optional*, defaults to `True`):
            Whether or not the model should return a [`~transformers_openvla_oft.utils.ModelOutput`] instead of a plain tuple.
        ...
        return_dict_in_generate (`bool`, *optional*, defaults to `False`):
            Whether the model should return a [`~transformers_openvla_oft.utils.ModelOutput`] instead of a `torch.LongTensor`.
    ...
    def register_for_auto_class(cls, auto_class="AutoConfig"):
        ...
        import transformers_openvla_oft.models.auto as auto_module
...
def get_configuration_file(configuration_files: List[str]) -> str:
    """
    Get the configuration file to use for this version of transformers_openvla_oft.
