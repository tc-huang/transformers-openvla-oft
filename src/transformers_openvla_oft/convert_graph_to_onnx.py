...
from transformers_openvla_oft.pipelines import Pipeline, pipeline
from transformers_openvla_oft.tokenization_utils import BatchEncoding
from transformers_openvla_oft.utils import ModelOutput, is_tf_available, is_torch_available
...
def convert(
    ...
    **model_kwargs,
    ...
    """
    warnings.warn(
        "The `transformers_openvla_oft.convert_graph_to_onnx` package is deprecated and will be removed in version 5 of"
        " Transformers",
        FutureWarning,
    )
