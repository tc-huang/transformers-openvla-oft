...
class HfQuantizer(ABC):
    ...
    This class is used only for transformers_openvla_oft.PreTrainedModel.from_pretrained and cannot be easily used outside the scope of that method
    yet.

    Attributes
        quantization_config (`transformers_openvla_oft.utils.quantization_config.QuantizationConfigMixin`):
    ...
    def get_special_dtypes_update(self, model, torch_dtype: "torch.dtype") -> Dict[str, "torch.dtype"]:
        ...
        Args:
            model (`~transformers_openvla_oft.PreTrainedModel`):
    ...
    def validate_environment(self, *args, **kwargs):
        ...
        passed in `from_pretrained`. You need to define it for all future quantizers that are integrated with transformers_openvla_oft.
