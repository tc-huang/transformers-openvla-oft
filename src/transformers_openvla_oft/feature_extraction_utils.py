...
class BatchFeature(UserDict):
    ...
    # Copied from transformers_openvla_oft.tokenization_utils_base.BatchEncoding.keys
    def keys(self):
        return self.data.keys()

    # Copied from transformers_openvla_oft.tokenization_utils_base.BatchEncoding.values
    def values(self):
        return self.data.values()

    # Copied from transformers_openvla_oft.tokenization_utils_base.BatchEncoding.items
    def items(self):
