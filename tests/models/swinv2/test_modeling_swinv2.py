...
from transformers_openvla_oft import Swinv2Config
...
if is_torch_available():
    ...
    from transformers_openvla_oft import Swinv2Backbone, Swinv2ForImageClassification, Swinv2ForMaskedImageModeling, Swinv2Model
