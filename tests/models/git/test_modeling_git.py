...
from transformers_openvla_oft import GitConfig, GitProcessor, GitVisionConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import MODEL_FOR_CAUSAL_LM_MAPPING, GitForCausalLM, GitModel, GitVisionModel
