...
from transformers_openvla_oft import XLMConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft.models.xlm.modeling_xlm import create_sinusoidal_embeddings
