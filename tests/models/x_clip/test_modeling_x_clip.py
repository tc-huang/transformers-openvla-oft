...
from transformers_openvla_oft import XCLIPConfig, XCLIPTextConfig, XCLIPVisionConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import XCLIPModel, XCLIPTextModel, XCLIPVisionModel


if is_vision_available():
    from transformers_openvla_oft import XCLIPProcessor
