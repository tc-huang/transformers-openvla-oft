...
from transformers_openvla_oft import BartConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft.models.bart.modeling_bart import BartDecoder, BartEncoder, shift_tokens_right
