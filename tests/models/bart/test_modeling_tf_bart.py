...
from transformers_openvla_oft import BartConfig, BartTokenizer, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFBartForConditionalGeneration, TFBartForSequenceClassification, TFBartModel
