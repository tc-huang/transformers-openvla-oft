...
from transformers_openvla_oft import AlbertConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TF_MODEL_FOR_PRETRAINING_MAPPING
    from transformers_openvla_oft.models.albert.modeling_tf_albert import (
        TFAlbertForMaskedLM,
