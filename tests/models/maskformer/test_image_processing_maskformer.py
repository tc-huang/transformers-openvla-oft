...
if is_torch_available():
    ...
    if is_vision_available():
        from transformers_openvla_oft import MaskFormerImageProcessor
        from transformers_openvla_oft.models.maskformer.image_processing_maskformer import binary_mask_to_rle
        from transformers_openvla_oft.models.maskformer.modeling_maskformer import MaskFormerForInstanceSegmentationOutput
