...
from transformers_openvla_oft.testing_utils import require_g2p_en, require_torch, require_torch_accelerator, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_openvla_oft import FastSpeech2ConformerModel, FastSpeech2ConformerWithHifiGan, set_seed
