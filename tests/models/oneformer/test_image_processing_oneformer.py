...
if is_torch_available():
    ...
    if is_vision_available():
        from transformers_openvla_oft import OneFormerImageProcessor
        from transformers_openvla_oft.models.oneformer.image_processing_oneformer import binary_mask_to_rle, prepare_metadata
