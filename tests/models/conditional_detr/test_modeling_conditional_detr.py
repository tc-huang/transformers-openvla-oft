...
from transformers_openvla_oft import ConditionalDetrConfig, ResNetConfig, is_torch_available, is_vision_available
...
if is_vision_available():
    ...
    from transformers_openvla_oft import ConditionalDetrImageProcessor
