...
from transformers_openvla_oft import RegNetConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.regnet.modeling_flax_regnet import FlaxRegNetForImageClassification, FlaxRegNetModel
