...
from transformers_openvla_oft import FSMTConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import FSMTForConditionalGeneration, FSMTModel, FSMTTokenizer
    from transformers_openvla_oft.models.fsmt.modeling_fsmt import (
        SinusoidalPositionalEmbedding,
        _prepare_fsmt_decoder_inputs,
        invert_mask,
        shift_tokens_right,
    )
    from transformers_openvla_oft.pipelines import TranslationPipeline
