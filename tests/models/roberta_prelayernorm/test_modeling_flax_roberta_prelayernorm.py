...
from transformers_openvla_oft import RobertaPreLayerNormConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.roberta_prelayernorm.modeling_flax_roberta_prelayernorm import (
