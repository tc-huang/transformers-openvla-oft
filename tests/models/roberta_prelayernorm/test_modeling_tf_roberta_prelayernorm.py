...
from transformers_openvla_oft import RobertaPreLayerNormConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft.models.roberta_prelayernorm.modeling_tf_roberta_prelayernorm import (
