...
from transformers_openvla_oft import XLMRobertaXLConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft.models.xlm_roberta_xl.modeling_xlm_roberta_xl import (
