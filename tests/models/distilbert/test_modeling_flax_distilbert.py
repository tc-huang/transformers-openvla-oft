...
from transformers_openvla_oft import DistilBertConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.distilbert.modeling_flax_distilbert import (
