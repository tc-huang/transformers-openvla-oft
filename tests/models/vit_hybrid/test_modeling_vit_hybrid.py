...
from transformers_openvla_oft import ViTHybridConfig
from transformers_openvla_oft.testing_utils import is_flaky, require_accelerate, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_openvla_oft import ViTHybridForImageClassification, ViTHybridImageProcessor, ViTHybridModel
