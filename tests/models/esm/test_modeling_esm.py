...
from transformers_openvla_oft import EsmConfig, is_torch_available
from transformers_openvla_oft.testing_utils import TestCasePlus, require_bitsandbytes, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_openvla_oft import EsmForMaskedLM, EsmForSequenceClassification, EsmForTokenClassification, EsmModel
    from transformers_openvla_oft.models.esm.modeling_esm import (
        EsmEmbeddings,
