...
from transformers_openvla_oft import SPIECE_UNDERLINE, BatchEncoding, PLBartTokenizer, is_torch_available
...
if is_torch_available():
    from transformers_openvla_oft.models.plbart.modeling_plbart import shift_tokens_right
