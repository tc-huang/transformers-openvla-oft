...
if is_torch_available():
    ...
    from transformers_openvla_oft import MODEL_MAPPING, PoolFormerConfig, PoolFormerForImageClassification, PoolFormerModel


if is_vision_available():
    from PIL import Image

    from transformers_openvla_oft import PoolFormerImageProcessor
