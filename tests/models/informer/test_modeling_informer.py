...
if is_torch_available():
    ...
    from transformers_openvla_oft import InformerConfig, InformerForPrediction, InformerModel
    from transformers_openvla_oft.models.informer.modeling_informer import (
        InformerDecoder,
        InformerEncoder,
