...
from transformers_openvla_oft import BertGenerationConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import BertGenerationDecoder, BertGenerationEncoder
