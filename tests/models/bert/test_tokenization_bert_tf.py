...
from transformers_openvla_oft import AutoConfig, TFAutoModel, is_tensorflow_text_available, is_tf_available
...
if is_tensorflow_text_available():
    from transformers_openvla_oft.models.bert import TFBertTokenizer
