...
from transformers_openvla_oft import VivitConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import MODEL_FOR_VIDEO_CLASSIFICATION_MAPPING, VivitForVideoClassification, VivitModel


if is_vision_available():
    from transformers_openvla_oft import VivitImageProcessor
