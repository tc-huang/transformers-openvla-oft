...
from transformers_openvla_oft import AltCLIPConfig, AltCLIPProcessor, AltCLIPTextConfig, AltCLIPVisionConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import AltCLIPModel, AltCLIPTextModel, AltCLIPVisionModel
