...
from transformers_openvla_oft import VitMatteConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import VitDetConfig, VitMatteForImageMatting


if is_vision_available():
    from PIL import Image

    from transformers_openvla_oft import VitMatteImageProcessor
