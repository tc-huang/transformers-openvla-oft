...
from transformers_openvla_oft import DPRConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import DPRContextEncoder, DPRQuestionEncoder, DPRReader, DPRReaderTokenizer
