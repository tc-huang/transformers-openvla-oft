...
from transformers_openvla_oft import MistralConfig, is_flax_available, is_tokenizers_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.mistral.modeling_flax_mistral import (
