...
from transformers_openvla_oft import MixtralConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import MixtralForCausalLM, MixtralForSequenceClassification, MixtralModel
