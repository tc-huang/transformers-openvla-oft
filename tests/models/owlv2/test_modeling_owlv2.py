...
from transformers_openvla_oft import Owlv2Config, Owlv2TextConfig, Owlv2VisionConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import Owlv2ForObjectDetection, Owlv2Model, Owlv2TextModel, Owlv2VisionModel
