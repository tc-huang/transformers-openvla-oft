...
from transformers_openvla_oft import AutoTokenizer, GPTJConfig, is_tf_available
from transformers_openvla_oft.testing_utils import require_tf, slow, tooslow
...
if is_tf_available():
    ...
    from transformers_openvla_oft.models.gptj.modeling_tf_gptj import (
        TFGPTJForCausalLM,
