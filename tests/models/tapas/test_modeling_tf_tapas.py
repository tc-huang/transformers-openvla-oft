...
from transformers_openvla_oft.testing_utils import require_tensorflow_probability, require_tf, slow
...
if is_tf_available():
    ...
    from transformers_openvla_oft.models.tapas.modeling_tf_tapas import (
        IndexMap,
        ProductIndexMap,
        flatten,
        gather,
