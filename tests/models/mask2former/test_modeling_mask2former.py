...
from transformers_openvla_oft import Mask2FormerConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import Mask2FormerForUniversalSegmentation, Mask2FormerModel
