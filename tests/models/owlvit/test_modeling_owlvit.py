...
from transformers_openvla_oft import OwlViTConfig, OwlViTTextConfig, OwlViTVisionConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import OwlViTForObjectDetection, OwlViTModel, OwlViTTextModel, OwlViTVisionModel


if is_vision_available():
    from PIL import Image

    from transformers_openvla_oft import OwlViTProcessor
