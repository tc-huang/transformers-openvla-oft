...
from transformers_openvla_oft import T5Config, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import ByT5Tokenizer, T5Tokenizer, TFT5EncoderModel, TFT5ForConditionalGeneration, TFT5Model
