...
from transformers_openvla_oft.testing_utils import is_pt_flax_cross_test, require_torch, require_vision, slow, torch_device
...
if is_flax_available():
    from transformers_openvla_oft import FlaxVisionTextDualEncoderModel
...
if is_vision_available():
    ...
    from transformers_openvla_oft import VisionTextDualEncoderProcessor
