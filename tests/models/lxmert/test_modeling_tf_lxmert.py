...
from transformers_openvla_oft import LxmertConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft.models.lxmert.modeling_tf_lxmert import TFLxmertForPreTraining, TFLxmertModel
