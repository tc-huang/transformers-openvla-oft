...
from transformers_openvla_oft import BlenderbotSmallConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import BlenderbotSmallForConditionalGeneration, BlenderbotSmallModel, BlenderbotSmallTokenizer
    from transformers_openvla_oft.models.blenderbot_small.modeling_blenderbot_small import (
