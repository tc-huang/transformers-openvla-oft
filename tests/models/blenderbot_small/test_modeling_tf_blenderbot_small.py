...
from transformers_openvla_oft import BlenderbotSmallConfig, BlenderbotSmallTokenizer, is_tf_available
from transformers_openvla_oft.testing_utils import require_tf, require_tokenizers, slow
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFAutoModelForSeq2SeqLM, TFBlenderbotSmallForConditionalGeneration, TFBlenderbotSmallModel
