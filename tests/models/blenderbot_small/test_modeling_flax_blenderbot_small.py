...
from transformers_openvla_oft import BlenderbotSmallConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.blenderbot_small.modeling_flax_blenderbot_small import (
