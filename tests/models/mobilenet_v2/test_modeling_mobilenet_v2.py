...
from transformers_openvla_oft import MobileNetV2Config
...
if is_torch_available():
    ...
    from transformers_openvla_oft import MobileNetV2ForImageClassification, MobileNetV2ForSemanticSegmentation, MobileNetV2Model


if is_vision_available():
    from PIL import Image

    from transformers_openvla_oft import MobileNetV2ImageProcessor
