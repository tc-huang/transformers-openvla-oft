...
from transformers_openvla_oft import DinatConfig
from transformers_openvla_oft.testing_utils import require_natten, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_openvla_oft import DinatBackbone, DinatForImageClassification, DinatModel
