...
from transformers_openvla_oft import ViTMAEConfig
from transformers_openvla_oft.file_utils import cached_property, is_tf_available, is_vision_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFViTMAEForPreTraining, TFViTMAEModel
