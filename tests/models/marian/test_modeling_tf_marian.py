...
from transformers_openvla_oft import AutoTokenizer, MarianConfig, MarianTokenizer, TranslationPipeline, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFAutoModelForSeq2SeqLM, TFMarianModel, TFMarianMTModel
