...
from transformers_openvla_oft import FNetTokenizer, FNetTokenizerFast
from transformers_openvla_oft.testing_utils import get_tests_dir, require_sentencepiece, require_tokenizers, slow, tooslow
