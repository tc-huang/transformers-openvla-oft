...
from transformers_openvla_oft import CLIPConfig, CLIPTextConfig, CLIPVisionConfig
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFCLIPModel, TFCLIPTextModel, TFCLIPVisionModel, TFSharedEmbeddings
