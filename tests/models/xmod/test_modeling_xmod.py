...
from transformers_openvla_oft import XLMRobertaTokenizer, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft.models.xmod.modeling_xmod import XmodEmbeddings, create_position_ids_from_input_ids
