...
from transformers_openvla_oft import AutoTokenizer, PegasusConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFAutoModelForSeq2SeqLM, TFPegasusForConditionalGeneration, TFPegasusModel
