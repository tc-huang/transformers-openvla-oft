...
from transformers_openvla_oft import PegasusConfig, PegasusTokenizer, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft import FlaxPegasusForConditionalGeneration, FlaxPegasusModel
