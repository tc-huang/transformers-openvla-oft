...
from transformers_openvla_oft.utils import cached_property, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import Speech2TextProcessor, TFSpeech2TextForConditionalGeneration, TFSpeech2TextModel
