...
from transformers_openvla_oft import CONFIG_MAPPING, AutoConfig, BertConfig, GPT2Config, T5Config, TapasConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft.models.auto.modeling_tf_auto import (
