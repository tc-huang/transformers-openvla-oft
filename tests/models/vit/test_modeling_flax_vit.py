...
from transformers_openvla_oft import ViTConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers_openvla_oft.models.vit.modeling_flax_vit import FlaxViTForImageClassification, FlaxViTModel
