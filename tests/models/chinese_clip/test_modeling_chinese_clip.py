...
from transformers_openvla_oft import ChineseCLIPConfig, ChineseCLIPTextConfig, ChineseCLIPVisionConfig
...
if is_vision_available():
    ...
    from transformers_openvla_oft import ChineseCLIPProcessor
