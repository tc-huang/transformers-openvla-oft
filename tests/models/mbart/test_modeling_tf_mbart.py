...
from transformers_openvla_oft import AutoTokenizer, MBartConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFAutoModelForSeq2SeqLM, TFMBartForConditionalGeneration, TFMBartModel
