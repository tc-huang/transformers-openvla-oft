...
from transformers_openvla_oft import Swin2SRConfig
...
if is_torch_available():
    ...
    from transformers_openvla_oft import Swin2SRForImageSuperResolution, Swin2SRModel

if is_vision_available():
    from PIL import Image

    from transformers_openvla_oft import Swin2SRImageProcessor
