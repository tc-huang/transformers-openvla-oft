...
from transformers_openvla_oft import OPTConfig, is_torch_available
from transformers_openvla_oft.testing_utils import require_torch, require_torch_accelerator, require_torch_fp16, slow, torch_device
