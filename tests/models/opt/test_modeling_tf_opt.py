...
from transformers_openvla_oft import OPTConfig, is_tf_available
from transformers_openvla_oft.testing_utils import require_sentencepiece, require_tf, slow
...
if is_tf_available():
    ...
    from transformers_openvla_oft import GPT2Tokenizer, TFOPTForCausalLM, TFOPTModel
