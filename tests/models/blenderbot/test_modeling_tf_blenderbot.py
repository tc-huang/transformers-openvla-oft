...
from transformers_openvla_oft import BlenderbotConfig, BlenderbotTokenizer, is_tf_available
...
if is_tf_available():
    ...
    from transformers_openvla_oft import TFAutoModelForSeq2SeqLM, TFBlenderbotForConditionalGeneration, TFBlenderbotModel
