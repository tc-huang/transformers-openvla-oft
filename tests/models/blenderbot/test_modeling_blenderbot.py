...
from transformers_openvla_oft import BlenderbotConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_openvla_oft import BlenderbotForConditionalGeneration, BlenderbotModel, BlenderbotTokenizer
    from transformers_openvla_oft.models.blenderbot.modeling_blenderbot import (
        BlenderbotDecoder,
        BlenderbotEncoder,
