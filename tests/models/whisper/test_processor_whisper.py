...
from transformers_openvla_oft import WhisperTokenizer, is_speech_available
...
if is_speech_available():
    from transformers_openvla_oft import WhisperFeatureExtractor, WhisperProcessor
