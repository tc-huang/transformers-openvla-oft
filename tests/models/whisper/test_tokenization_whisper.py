...
from transformers_openvla_oft.models.whisper import WhisperTokenizer, WhisperTokenizerFast
from transformers_openvla_oft.models.whisper.tokenization_whisper import _combine_tokens_into_words, _find_longest_common_sequence
