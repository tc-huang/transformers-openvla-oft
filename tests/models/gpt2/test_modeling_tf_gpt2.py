...
from transformers_openvla_oft import GPT2Config, is_tf_available
from transformers_openvla_oft.testing_utils import require_tf, require_tf2onnx, slow
...
if is_tf_available():
    ...
    from transformers_openvla_oft import GPT2Tokenizer
    from transformers_openvla_oft.models.gpt2.modeling_tf_gpt2 import (
        TFGPT2DoubleHeadsModel,
        TFGPT2ForSequenceClassification,
        TFGPT2LMHeadModel,
        TFGPT2Model,
    )
    from transformers_openvla_oft.tf_utils import shape_list
