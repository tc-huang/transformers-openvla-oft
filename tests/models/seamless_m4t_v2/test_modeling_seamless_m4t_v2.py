...
from transformers_openvla_oft import SeamlessM4Tv2Config, is_speech_available, is_torch_available
...
if is_speech_available():
    from transformers_openvla_oft import SeamlessM4TProcessor
