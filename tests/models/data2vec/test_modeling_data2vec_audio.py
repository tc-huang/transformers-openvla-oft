...
from transformers_openvla_oft import Data2VecAudioConfig, is_torch_available
from transformers_openvla_oft.testing_utils import is_pt_flax_cross_test, require_soundfile, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_openvla_oft.models.data2vec.modeling_data2vec_audio import _compute_mask_indices
