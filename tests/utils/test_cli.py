...
from transformers_openvla_oft.testing_utils import CaptureStd, is_pt_tf_cross_test, require_torch
...
class CLITest(unittest.TestCase):
    ...
    def test_cli_env(self):
        ...
        import transformers_openvla_oft.commands.transformers_cli

        with CaptureStd() as cs:
            transformers_openvla_oft.commands.transformers_cli.main()
