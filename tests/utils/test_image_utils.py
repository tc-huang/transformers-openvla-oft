...
from transformers_openvla_oft.image_utils import ChannelDimension, get_channel_dimension_axis, make_list_of_images
from transformers_openvla_oft.testing_utils import is_flaky, require_torch, require_vision
...
if is_vision_available():
    ...
    from transformers_openvla_oft import ImageFeatureExtractionMixin
    from transformers_openvla_oft.image_utils import get_image_size, infer_channel_dimension_format, load_image
