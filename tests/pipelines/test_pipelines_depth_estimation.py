...
from transformers_openvla_oft import MODEL_FOR_DEPTH_ESTIMATION_MAPPING, is_torch_available, is_vision_available
from transformers_openvla_oft.pipelines import DepthEstimationPipeline, pipeline
