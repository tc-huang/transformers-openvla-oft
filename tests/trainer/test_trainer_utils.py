...
from transformers_openvla_oft.data.data_collator import default_data_collator
from transformers_openvla_oft.testing_utils import require_accelerate, require_torch
from transformers_openvla_oft.trainer_utils import RemoveColumnsCollator, find_executable_batch_size
...
if is_torch_available():
    ...
    from transformers_openvla_oft.modeling_outputs import SequenceClassifierOutput
    from transformers_openvla_oft.tokenization_utils_base import BatchEncoding
    from transformers_openvla_oft.trainer_pt_utils import (
