...
from transformers_openvla_oft import AqlmConfig, AutoConfig, AutoModelForCausalLM, AutoTokenizer, OPTForCausalLM, StaticCache
...
from transformers_openvla_oft.utils import is_accelerate_available, is_aqlm_available, is_torch_available
...
class AqlmTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        from transformers_openvla_oft.integrations import replace_with_aqlm_linear
