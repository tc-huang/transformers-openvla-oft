...
class MixedInt8Test(BaseMixedInt8Test):
    ...
    def test_get_keys_to_not_convert_trust_remote_code(self):
        ...
        from transformers_openvla_oft.integrations.bitsandbytes import get_keys_to_not_convert
    ...
    def test_get_keys_to_not_convert(self):
        ...
        from transformers_openvla_oft import AutoModelForMaskedLM, Blip2ForConditionalGeneration, MptForCausalLM, OPTForCausalLM
        from transformers_openvla_oft.integrations.bitsandbytes import get_keys_to_not_convert
...
class MixedInt8TestPipeline(BaseMixedInt8Test):
    ...
    def test_pipeline(self):
        r"""
        The aim of this test is to verify that the mixed int8 is compatible with `pipeline` from transformers_openvla_oft. Since
