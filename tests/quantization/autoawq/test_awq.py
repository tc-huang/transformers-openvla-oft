...
from transformers_openvla_oft import AutoConfig, AutoModelForCausalLM, AutoTokenizer, AwqConfig, OPTForCausalLM
...
from transformers_openvla_oft.utils import is_accelerate_available, is_torch_available
...
class AwqTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        from transformers_openvla_oft.integrations.awq import replace_with_awq_linear
